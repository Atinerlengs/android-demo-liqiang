...
FREEME_FASHION_LAUNCHER_SUPPORT = yes
FREEME_PRIVATE_WIDGET_NEWS_PAGE_SUPPORT = yes
FREEME_THEME_CLUB_SUPPORT = yes
FREEME_BIGLAUNCHER_APP = yes
FREEME_SUPPER_POWER_SAVE_SUPPORT = no
FREEME_FESTIVALWALLPAPER_APP = yes
FREEME_LOCK_NOW_APP= yes
FREEME_THEMES_RESOURCES = yes
FREEME_SHAKE_OPEN_APP_SUPPORT=yes
# @} ###########################################################################


# @{ freeme.John, 20160603. For FreemeSS. ######################################
FREEME_LUCKY_MONEY_APP = yes
FREEME_OOBE_APP=yes
...
# ---- 3rd Apps ----
FREEME_3RD_BAOFENGVIDEO=yes
FREEME_3RD_KUWOPLAYE=yes
FREEME_3RD_TAOBAO=yes
FREEME_3RD_AIMEITUAN=yes
FREEME_3RD_ZYCP=yes
FREEME_3RD_DAZHDIANPING=yes

# -- Google GMS
BUILD_GMS = no
FREEME_GOOGLE_BOOKS = no
FREEME_GOOGLE_CHROME = no
FREEME_GOOGLE_DRIVE = no
FREEME_GOOGLE_GMAIL2 = no
FREEME_GOOGLE_HANGOUTS = no
FREEME_GOOGLE_LATINIME = no
FREEME_GOOGLE_MAPS = no
FREEME_GOOGLE_GAME = no
FREEME_GOOGLE_PLAYMUSIC = no
FREEME_GOOGLE_PLAYMOIVE = no
FREEME_GOOGLE_PLAYSTORE = no
FREEME_GOOGLE_PLUSONE = no
FREEME_GOOGLE_NEWSSTAND = no
FREEME_GOOGLE_TALKBACK = no
FREEME_GOOGLE_TTS = no
FREEME_GOOGLE_YOUTUBE = no
FREEME_GOOGLE_VELVET = no
FREEME_SETUPWIZARD = no
FREEME_GOOGLE_PHOTOS = no
FREEME_GOOGLE_CALENDAR = no
