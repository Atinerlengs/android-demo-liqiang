 ...
 *         <tr>
 *             <td >src/com.example.freeme.apis/view/AlertDialogSamples.java</td>
...
public class AlertDialogSamples extends Activity {
    ...
    private static final int DIALOG_BOTTOM = 15;
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        case DIALOG_BOTTOM:
            return new AlertDialog.Builder(AlertDialogSamples.this)
                .setTitle(R.string.freeme_alert_dialog_bottom_button)
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bottomButton = (Button) findViewById(R.id.bottom_button_freeme);
        bottomButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showDialog(DIALOG_BOTTOM);
            }
        });
