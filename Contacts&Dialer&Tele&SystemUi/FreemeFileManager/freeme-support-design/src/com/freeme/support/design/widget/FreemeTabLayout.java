package com.freeme.support.design.widget;
...
public class FreemeTabLayout extends HorizontalScrollView {
    ...
    public FreemeTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.freeme.support.design.R.styleable.FreemeTabLayout,
                defStyleAttr, com.freeme.support.design.R.style.Widget_Freeme_Design_TabLayout);

        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_indicatorHeight, 0));
        mTabStrip.setSelectedIndicatorColor(a.getColor(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_indicatorColor, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_padding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_paddingStart,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_paddingTop,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_paddingEnd,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_paddingBottom,
                mTabPaddingBottom);

        mTabTextAppearance = a.getResourceId(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_textAppearance,
                com.freeme.support.design.R.style.TextAppearance_Freeme_Design_Tab);
        ...
        if (a.hasValue(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_textColor)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_textColor);
        }

        if (a.hasValue(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_selectedTextColor)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_selectedTextColor, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        mRequestedTabHeight = a.getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_height,
                dpToPx(DEFAULT_HEIGHT));

        mRequestedTabMinWidth = a.getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_minWidth,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_maxWidth,
                INVALID_WIDTH);
        mTabBackgroundResId = a.getResourceId(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_background, 0);
        mTabGravity = a.getInt(com.freeme.support.design.R.styleable.FreemeTabLayout_tab_gravity, GRAVITY_CENTER);
        a.recycle();
            ...
            if (mCustomView == null) {
                ...
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(com.freeme.support.design.R.layout.freeme_design_layout_tab_text, this, false);
                    addView(textView);
                    mTextView = textView;
