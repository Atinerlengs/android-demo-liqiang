...
public class MediaFile {
    ...
    private static final int LAST_DOC_FILE_TYPE = FILE_TYPE_MS_POWERPOINT;
    ...
    static {
        ...
        addFileType("VOB", FILE_TYPE_MP4, "video/mpeg", MtpConstants.FORMAT_MPEG, false);
    ...
    public static boolean isDocFileType(int fileType) {
        return (fileType >= FIRST_DOC_FILE_TYPE && fileType <= LAST_DOC_FILE_TYPE);
    }
