...
public class FileIconLoader implements Callback {
     ...
     */
    private final LinkedHashMap<ImageView, FileId> mPendingRequests = new LinkedHashMap<ImageView, FileId>();
    ...
    private class LoaderThread extends HandlerThread implements Callback {
        ...
        public boolean handleMessage(Message msg) {
            ...
            if (iterator.hasNext()) {
                ...
                try {
                    ...
                    Log.v("FileIconLoader", e.toString());
                    return true;
                }
                ...
                if (holder != null && holder.state == ImageHolder.NEEDED) {
                    ...
                    switch (id.mCategory) {
                        ...
                        case Video:
                            ...
                            holder.setImage(getVideoThumbnail(id.mId));
                            break;
                    }
        ...
        private Bitmap getImageThumbnail(long id) {
            Bitmap thumbnail = Images.Thumbnails.getThumbnail(mContext.getContentResolver(), id, Images.Thumbnails.MINI_KIND, null);
            if (thumbnail != null) {
                thumbnail = Util.toRoundCorner(thumbnail, 6);
            }
            return thumbnail;
        }

        private Bitmap getVideoThumbnail(long id) {
            Bitmap thumbnail = Video.Thumbnails.getThumbnail(mContext.getContentResolver(), id, Images.Thumbnails.MICRO_KIND, null);
            if (thumbnail != null) {
