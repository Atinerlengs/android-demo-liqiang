...
public final class MimeUtils {
    ...
    public static boolean is3GPP(String filePath) {
        //todo should contain all formats that can be video or audio
        String ext = getRealExtension(filePath);
        if (ext == null) {
            return false;
        }
        if (ext.equals("3gpp") || ext.equals("3gp")) {
            return true;
        } else {
            return false;
        }
    ...
    public static boolean is3GPPExtension(String ext) {
        //todo should contain all formats that can be video or audio
        if (ext.equals("3gpp") || ext.equals("3gp")) {
            return true;
        } else {
