package com.freeme.incallui.video;
...
public class FreemeVideoDebugInfo {
    private static final String ENGINEER_MODE_OPTION = "persist.radio.vilte_RTPInfo";
    private FreemeVideoCallFragment mFragment;
    private RelativeLayout mParentLayout;
    private TextView mDebugInfoView;
    private long lossRate ;

    public void setFragment(FreemeVideoCallFragment fragmentShowInfo) {
