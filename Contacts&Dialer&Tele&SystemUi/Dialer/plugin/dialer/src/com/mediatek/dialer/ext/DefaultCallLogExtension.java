...
//        Log.d(TAG, msg + " default");
  ...
  /**
    ...
    */
    ...
    /**.
     * for OP02
     * plug-in refresh the CallLogFragment to show the account notice
     * @param fragment the current fragment
     */
    @Override
