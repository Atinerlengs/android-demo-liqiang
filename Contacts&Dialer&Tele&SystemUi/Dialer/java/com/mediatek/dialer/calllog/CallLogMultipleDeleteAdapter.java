...
public class CallLogMultipleDeleteAdapter extends CallLogAdapter {
     ...
     * @param contactInfoCache
     * @param voicemailNumber voicemailNumber
     */
    public CallLogMultipleDeleteAdapter(Activity context, CallFetcher callFetcher,
            ContactInfoCache contactInfoCache) {
        super(context, /*alertContainer*/null, callFetcher,
