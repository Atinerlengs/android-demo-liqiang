...
public class DialerSearchCursorLoader extends AsyncTaskLoader<Cursor> {
    ...
    public void configureQuery(String query, boolean isSmartQuery) {
        ...
        Log.d(TAG, "MTK-DialerSearch, Configure new query to be " + LogUtil.sanitizePii(query));
    ...
    public Cursor loadInBackground() {
        ...
        Log.d(TAG, "MTK-DialerSearch, Load in background. mQuery: " + LogUtil.sanitizePii(mQuery));
