...
public class SelectPhoneAccountDialogFragment extends DialogFragment {
  ...
  private static class SelectAccountListAdapter extends ArrayAdapter<PhoneAccountHandle> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      /*/ freeme.liqiang, 20180325. redesigh select phone account dialog
      holder.imageView.setImageDrawable(
          PhoneAccountCompat.createIconDrawable(account, getContext()));
      /*/
      setIconImageResource(position, holder.imageView);
      //*/
      return rowView;
    }
  ...
  /// @}
    ...
    //*/ freeme.liqiang, 20180325. redesigh select phone account dialog
    private static void setIconImageResource(int position, ImageView imageView) {
        if (position == 0) {
            imageView.setImageResource(R.drawable.freeme_contact_account_icon_sim1);
        } else if (position == 1) {
            imageView.setImageResource(R.drawable.freeme_contact_account_icon_sim2);
        }
    }
    //*/
}
