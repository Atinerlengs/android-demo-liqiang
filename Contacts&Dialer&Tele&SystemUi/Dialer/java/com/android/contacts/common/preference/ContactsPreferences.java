...
public class ContactsPreferences implements OnSharedPreferenceChangeListener {
  ...
  public void refreshValue(String key) {
    //*/ freeme.zhaozehong, 20180119. for freemeOS, control refresh contacts data
    ...
    //*/ freeme.zhaozehong, 20180119. for freemeOS, control refresh contacts data
    // the SharedPreference changed is not caused by changes in one of DISPLAY_ORDER_KEY
    // or SORT_ORDER_KEY or mDefaultAccountKey
    else {
        isChange = false;
    }
    if (isChange)
