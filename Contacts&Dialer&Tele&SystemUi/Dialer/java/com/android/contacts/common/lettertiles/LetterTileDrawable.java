...
public class LetterTileDrawable extends Drawable {
  ...
  public LetterTileDrawable(final Resources res) {
    ...
    /*/
    mDefaultPersonAvatar =
        res.getDrawable(R.drawable.freeme_list_default_stranger, null);
    //*/
  ...
  /*/ freeme.zhaozehong, 20180329. for freemeOS, to be Override
  private void drawLetterTile(final Canvas canvas) {
  /*/
  public void drawLetterTile(final Canvas canvas) {
  //*/
  ...
  public void drawAvatarWithOutLetter(Canvas canvas){
    Drawable drawable = getDrawableForContactType(mContactType);
    if (drawable == null) {
      throw Assert.createIllegalStateFailException(
              "Unable to find drawable for contact type " + mContactType);
