...
public class SmsBottomSheetFragment extends BottomSheetDialogFragment {
  ...
  public View onCreateView(
    ...
    int padding = (int) DpUtil.dpToPx(getContext(), 20);
    layout.setPadding(padding, 0, 0, 0);
    layout.setDividerDrawable(new ColorDrawable(0x1fffffff));
  ...
  private TextView newTextViewItem(@Nullable final CharSequence text) {
    ...
    TextView textView = new TextView(context);
    textView.setText(text == null ? getString(R.string.call_incoming_message_custom) : text);
    textView.setTextAppearance(R.style.Dialer_Incall_Answer_Menu_Text_SMS);
    textView.setGravity(android.view.Gravity.CENTER_VERTICAL);
    textView.setMinHeight((int) DpUtil.dpToPx(context, 48));
    int padding = (int) DpUtil.dpToPx(getContext(), 10);
