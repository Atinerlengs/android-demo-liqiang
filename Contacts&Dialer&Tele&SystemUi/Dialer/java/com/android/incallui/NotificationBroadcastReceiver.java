  ...
  private void answerIncomingCall(Context context, int videoState) {
    ...
    if (callList == null) {
      ...
      if (call != null) {
        ...
        //*/ freeme.zhaozehong, 20180416. GameMode, do not show InCallActivity in game mode
        if (!new com.freeme.incallui.utils.FreemeGameModeUtils(context).answerCallViaSpeaker())
        //*/
