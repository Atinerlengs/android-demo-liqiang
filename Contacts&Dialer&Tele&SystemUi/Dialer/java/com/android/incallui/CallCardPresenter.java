...
public class CallCardPresenter
  ...
  public void onStateChange(InCallState oldState, InCallState newState, CallList callList) {
    ...
    InCallPresenter.getInstance().setInCallState(newState);
    //*/
      ...
      getUi()
          .setCallState(
              new PrimaryCallState(
                  ...
                  mPrimary.isVideoCallExcludeVideoRingtone(),
                  /// @}
                  mPrimary.getVideoTech().getSessionModificationState(),
                  ...
                  /*/
                  supports2ndCallOnHold()).setFreemeExtra(mPrimary.getId(), mPrimary.getCallSubId(),
                      mPrimary.isConferenceCall()));
                  //*/
    ...
    if (mPrimary.isConferenceCall()
      ...
      mInCallScreen.setPrimary(
          new PrimaryInfo(
              ...
              /*/
              mPrimary.getNumberPresentation())
                  .setFreemeExtras(true, mPrimary.getId(), true)
              );
              //*/
      ...
      mInCallScreen.setPrimary(
          new PrimaryInfo(
              ...
              /*/
              mPrimary.getNumberPresentation())
                  .setFreemeExtras(true, mPrimary.getId(), false)
              );
              //*/
    } else {
      // Clear the primary display info.
    ...
    if (mSecondary.isConferenceCall()) {
      mInCallScreen.setSecondary(
          new SecondaryInfo(
              ...
              /// M: add color for secondady.
              InCallPresenter.getInstance().getPrimaryColorFromCall(mSecondary))
                  .setExtras(mSecondaryContactInfo.lookupKey,
                          mSecondaryContactInfo.number, mSecondary.getId()));
              //*/
  ...
  private String getNameForCall(ContactCacheEntry contactInfo) {
    ...
    if (TextUtils.isEmpty(preferredName)) {
      ...
      /*/
      return mContext.getString(R.string.freeme_incall_stranger_number);
      //*/
    }
