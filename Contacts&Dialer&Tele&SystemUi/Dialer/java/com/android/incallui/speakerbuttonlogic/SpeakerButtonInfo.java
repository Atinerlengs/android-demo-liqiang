  ...
  public SpeakerButtonInfo(CallAudioState audioState, @IconSize int iconSize) {
    if ((audioState.getSupportedRouteMask() & CallAudioState.ROUTE_BLUETOOTH)
      ...
      if ((audioState.getRoute() & CallAudioState.ROUTE_BLUETOOTH)
        ...
        /*/
        icon = R.drawable.freeme_call_card_button_audio_bluetooth;
        //*/
        ...
        /*/
        icon = R.drawable.freeme_call_card_button_audio_speaker_selected;
        //*/
        ...
        /*/
        icon = R.drawable.freeme_call_card_button_audio_wired_handset;
        //*/
        ...
        /*/
        icon = R.drawable.freeme_call_card_button_audio_handset;
        //*/
      ...
      icon =
          iconSize == IconSize.SIZE_36_DP
              ...
              : R.drawable.quantum_ic_volume_up_white_24;
      /*/
      icon = R.drawable.freeme_call_card_button_audio_speaker;
      //*/
      contentDescription = R.string.incall_content_description_speaker;
    }
  }
