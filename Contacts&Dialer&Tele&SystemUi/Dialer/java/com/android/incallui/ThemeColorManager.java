...
public class ThemeColorManager {
  ...
  public void onForegroundCallChanged(Context context, @Nullable DialerCall newForegroundCall) {
    if (newForegroundCall == null) {
      ...
      @ColorInt int highlightColor = getHighlightColor(context, pendingPhoneAccountHandle);
      updateThemeColors(context, highlightColor, false);
      /// @}
    } else {
      /// M: ALPS03809577. Improve volte mo call performance. @{
      /// Google code:
      /// updateThemeColors(context, newForegroundCall.getAccountHandle(), newForegroundCall.isSpam());
      updateThemeColors(context, newForegroundCall.getAccountColor(), newForegroundCall.isSpam());
      /// @}
    }
  }
  ...
  private void updateThemeColors(
      Context context,
      /// M: ALPS03809577. Improve volte mo call performance. @{
      /// Google code: @Nullable PhoneAccountHandle handle,
