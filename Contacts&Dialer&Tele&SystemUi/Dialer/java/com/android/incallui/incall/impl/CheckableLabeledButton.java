...
public class CheckableLabeledButton extends LinearLayout implements Checkable {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    /*/
    int padding = getResources().getDimensionPixelOffset(R.dimen.freeme_incall_button_bottom_padding);
    ...
    /*/
    int iconSize = getResources().getDimensionPixelSize(R.dimen.freeme_incall_button_icon_size);
    //*/
    ...
    /*/
    labelParams.topMargin = context.getResources().getDimensionPixelOffset(
            R.dimen.freeme_incall_button_label_margin);
    //*/
  ...
  public void refreshDrawableState() {
    ...
    /*/ freeme.zhaozehong, 20180313. for freemeOS, UI redesign
  ...
  public void setIsHideLabel(boolean isHideLabel) {
    this.mIsHideLabel = isHideLabel;
    labelView.setVisibility(mIsHideLabel ? GONE : VISIBLE);
  }
