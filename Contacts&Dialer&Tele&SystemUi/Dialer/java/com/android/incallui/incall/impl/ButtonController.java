...
//*/ freeme.zhaozehong, 20180317. for freemeOS, UI redesign
...
interface ButtonController {
  ...
  abstract class SimpleCheckableButtonController extends CheckableButtonController {
    ...
    public void setButton(CheckableLabeledButton button) {
      ...
      protected void setNewLabel(String label) {
          this.newLabel = label;
      }
      //*/
  }
  ...
  class MuteButtonController extends SimpleCheckableButtonController {
    ...
    public MuteButtonController(InCallButtonUiDelegate delegate) {
      ...
      super(
              ...
              R.string.incall_content_description_unmuted,
              R.string.incall_label_mute,
              R.drawable.freeme_call_card_button_mute);
      //*/
    }
  ...
  class SpeakerButtonController
    ...
    /*/ freeme.zhaozehong, 20180312. for freemeOS, UI redesign
    ...
    /*/
    @DrawableRes private int icon = R.drawable.freeme_call_card_button_audio_speaker;
    //*/
  ...
  class DialpadButtonController extends SimpleCheckableButtonController {
    ...
    public DialpadButtonController(@NonNull InCallButtonUiDelegate delegate) {
      ...
      super(
              ...
              0,
              R.string.incall_label_dialpad,
              R.drawable.freeme_call_card_button_dialpad);
      //*/
    }
    ...
    public void doCheckedChanged(boolean isChecked) {
      ...
      if (isChecked) {
        delegate.setIsNumberRecord(false);
      }
      //*/
    }
  }
  ...
  class HoldButtonController extends SimpleCheckableButtonController {
    ...
    public HoldButtonController(@NonNull InCallButtonUiDelegate delegate) {
      ...
      super(
              ...
              R.string.incall_content_description_hold,
              R.string.incall_label_hold,
              R.drawable.freeme_call_card_button_hold);
      //*/
    }
  ...
  class AddCallButtonController extends SimpleNonCheckableButtonController {
    ...
    public AddCallButtonController(@NonNull InCallButtonUiDelegate delegate) {
      ...
      super(
              ...
              0,
              R.string.incall_label_add_call,
              R.drawable.freeme_call_card_button_add);
      //*/
      Assert.isNotNull(delegate);
    }
  ...
  class SwapButtonController extends SimpleNonCheckableButtonController {
    ...
    public SwapButtonController(@NonNull InCallButtonUiDelegate delegate) {
      ...
      super(
              ...
              R.string.incall_content_description_swap_calls,
              R.string.incall_label_swap,
              R.drawable.freeme_call_card_button_swap);
      //*/
      Assert.isNotNull(delegate);
    }
  ...
  class MergeButtonController extends SimpleNonCheckableButtonController {
    ...
    public MergeButtonController(@NonNull InCallButtonUiDelegate delegate) {
      ...
      super(
              ...
              R.string.incall_content_description_merge_calls,
              R.string.incall_label_merge,
              R.drawable.freeme_call_card_button_merge);
      //*/
      Assert.isNotNull(delegate);
    }
  ...
  class UpgradeToVideoButtonController extends SimpleNonCheckableButtonController {
    ...
    public UpgradeToVideoButtonController(@NonNull InCallButtonUiDelegate delegate) {
      ...
      super(
              ...
              0,
              R.string.incall_label_videocall,
              R.drawable.freeme_call_card_button_change_to_video);
      //*/
      Assert.isNotNull(delegate);
    }
  ...
  class SwitchVoiceRecordButtonController extends SimpleCheckableButtonController {
      ...
      public SwitchVoiceRecordButtonController(InCallButtonUiDelegate delegate) {
        ...
        super(
                ...
                R.string.start_record,
                R.string.start_record,
                R.drawable.freeme_call_card_button_record);
        //*/
      }
      ...
      //*/ freeme.zhaozehong, 20180317. for freemeOS, UI redesign
      private final int WHAT_UPDATE_RECORD_TIME = 1;

      public void showRecordTime(long time) {
          handler.removeMessages(WHAT_UPDATE_RECORD_TIME);
          if (time > 0) {
              long second = (SystemClock.elapsedRealtime() - time) / 1000;
              String timeStr = FreemeDateTimeUtils.getDurations(second, false);
              setNewLabel(timeStr);
              handler.obtainMessage(WHAT_UPDATE_RECORD_TIME, second).sendToTarget();
          } else {
              setNewLabel(null);
          }
      }
      ...
      private Handler handler = new Handler() {
          ...
          public void handleMessage(Message msg) {
              if (button != null) {
                  ...
                  String timeStr = FreemeDateTimeUtils.getDurations(time, false);
                  button.setLabelText(timeStr);
                  setNewLabel(timeStr);
                  sendMessageDelayed(obtainMessage(WHAT_UPDATE_RECORD_TIME, (time + 1)),
                          1000);
              }
          }
      };
  ...
  //*/ freeme.zhaozehong, 20180301. for freemeOS, UI redesign
  class NumberRecordButtonController extends SimpleCheckableButtonController {

    public NumberRecordButtonController(@NonNull InCallButtonUiDelegate delegate) {
      super(
              delegate,
              InCallButtonIds.BUTTON_RECORD_NUMBER,
              0,
              0,
              R.string.onscreenRecordNumberText,
              R.drawable.freeme_call_card_button_record_number);
    }
    ...
    public void doCheckedChanged(boolean isChecked) {
      delegate.showDialpadClicked(isChecked);
      if (isChecked) {
        delegate.setIsNumberRecord(true);
      }
    }
  }
  //*/
