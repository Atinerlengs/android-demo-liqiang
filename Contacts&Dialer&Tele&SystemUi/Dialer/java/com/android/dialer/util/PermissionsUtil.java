...
public class PermissionsUtil {
  ...
  //*/ freeme.chenming, 20180419. Check cta permission in CtaSupported
  private static final com.mediatek.cta.CtaManager CTA_MANAGER =
          com.mediatek.cta.CtaManagerFactory.getInstance().makeCtaManager();
  //*/
  ...
  /*/
  public static final String[] PHONE_FULL_GROUP = !CTA_MANAGER.isCtaSupported() ?
          new String[] {
            permission.CALL_PHONE, permission.READ_PHONE_STATE,
            permission.READ_CALL_LOG, permission.WRITE_CALL_LOG,
            permission.ADD_VOICEMAIL,
