...
//*/ freeme.zhaozehong, 20180322. for freemeOS, UI redesign
...
/*/
public class BlockedNumbersSettingsActivity extends Activity
//*/
  ...
  //*/ freeme.zhaozehong, 20180322. for freemeOS, UI redesign
  public static final String KEY_SKIP_BLOCKED_NUMBER_TIPS_ACTIVITY = "KEY_SKIP_BLOCKED_NUMBER_TIPS_ACTIVITY";
  private void needSkip() {
    SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
    boolean skip = sp.getBoolean(KEY_SKIP_BLOCKED_NUMBER_TIPS_ACTIVITY, false);
    if (skip) {
      startActivity(FilteredNumberCompat.createManageBlockedNumbersIntent(this));
      finish();
    }
  }
  //*/
