...
public class OldSpeedDialFragment extends Fragment
  ...
  public void onResume() {
    ...
    if (PermissionsUtil.hasContactsReadPermissions(getActivity())) {
      ...
      /*/
      mEmptyView.setDescription(R.string.listTotalAllContactsZeroStarred);
      //*/
    } else {
      /*/ freeme.zhaozehong, 20180123. for freemeOS, UI redesign
      ...
      /*/
      mEmptyView.setDescription(R.string.freeme_permission_no_favorites);
      //*/
    }
    Trace.endSection();
  }
  ...
  public View onCreateView(
    ...
    /*/
    mListView = mParentView.findViewById(R.id.contact_tile_list);
    //*/
    ...
    mEmptyView.setActionLabel(FreemeEmptyContentView.NO_LABEL);
    mEmptyView.setImage(R.drawable.freeme_empty_icon_stared_contacts);
    //*/
