...
public class ListsFragment extends Fragment implements OnPageChangeListener, Listener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    LogUtil.i("ListsFragment.onCreate", "after super.onCreate() ...");
    mVoicemailStatusHelper = new VoicemailStatusHelper();
    LogUtil.i("ListsFragment.onCreate", "after VoicemailStatusHelper created ...");
  ...
  @Override
  public void onPause() {
    LogUtil.i("ListsFragment.onPause", null);
    if (mCurrentPage instanceof CallLogFragment) {
  ...
  public View onCreateView(
    ...
    LogUtil.i("ListsFragment.onCreateView", "start ...");
