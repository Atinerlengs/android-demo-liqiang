...
public class SearchFragment extends PhoneNumberPickerFragment {
  ...
  protected ContactEntryListAdapter createListAdapter() {
    ...
    /*/
    FreemeDialerPhoneNumberListAdapter adapter = new FreemeDialerPhoneNumberListAdapter(getActivity());
    //*/
  ...
  protected void onItemClick(int position, long id) {
    ...
    /*/
    final FreemeDialerPhoneNumberListAdapter adapter = (FreemeDialerPhoneNumberListAdapter) getAdapter();
    //*/
    final int shortcutType = adapter.getShortcutTypeFromPosition(position);
    final OnPhoneNumberPickerActionListener listener;
    final Intent intent;
    /*/ freeme.liqiang, 20180802. unified initialization number
    final String number;
    /*/
  ...
  public void resizeListView() {
    /*/ freeme.zhaozehong, 20180526. for freemeOS, do not resize ListView, keep full screen
    if (mSpacer == null) {
      return;
    }
  ...
  protected View inflateView(LayoutInflater inflater, ViewGroup container) {
    ...
    //*/ freeme.zhaozehong, 20180330. for freemeOS, UI redesign
    parent.setBackgroundColor(getResources().getColor(R.color.freeme_content_bg_color_light));
    //*/
    return parent;
  }
