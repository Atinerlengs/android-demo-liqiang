...
public class CallLogFragment extends Fragment
  ...
  public void onCreate(Bundle state) {
    LogUtil.i("CallLogFragment.onCreate", toString());
    ...
    LogUtil.i("CallLogFragment.onCreate", "end...");
  }
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
    LogUtil.i("CallLogFragment.onCreateView", "start ...");
    View view = inflater.inflate(R.layout.call_log_fragment, container, false);
    setupView(view);
    LogUtil.i("CallLogFragment.onCreateView", "end ...");
    return view;
  }
  ...
  protected void setupData() {
    LogUtil.i("CallLogFragment.setupData", "start ...");
    int activityType =
        mIsCallLogActivity
    ...
    fetchCalls();
    LogUtil.i("CallLogFragment.setupData", "end ...");
  }
  ...
  public void onResume() {
    LogUtil.i("CallLogFragment.onResume", toString());
    super.onResume();
  ...
  @Override
  public void onStart() {
    LogUtil.i("CallLogFragment.onStart()", "start ...");
    super.onStart();
    ...
    LogUtil.i("CallLogFragment.onStart()", "end ...");
  }
  ...
  private void refreshData() {
    LogUtil.i("CallLogFragment.refreshData", "start ...");
    ...
    /// @}
    LogUtil.i("CallLogFragment.refreshData", "end ...");
  }
