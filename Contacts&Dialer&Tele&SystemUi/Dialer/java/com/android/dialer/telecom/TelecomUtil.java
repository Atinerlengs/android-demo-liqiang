...
//*/ freeme.zhaozehong, 20180424. for freemeOS, for pre-start InCallScreen
...
public abstract class TelecomUtil {
  ...
  public static boolean placeCall(Context context, Intent intent) {
    if (hasCallPhonePermission(context)) {
      ...
      //*/ freeme.zhaozehong, 20180424. for freemeOS, for pre-start InCallScreen
      Intent preIntent = InCallActivity.getIntentPreStart(context, false,
              true, false);
      if (preIntent != null) {
        DialerUtils.startActivityWithErrorToast(context, preIntent);
      }
      //*/
      return true;
    }
