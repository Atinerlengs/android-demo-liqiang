...
//*/ freeme.liqiang, 20180321. add back title
...
public class VoicemailSettingsFragment extends PreferenceFragment
  ...
  //*/ freeme.liqiang, 20180331. redesign voicemail settings
  private PreferenceCategory mVoicemailSettingPreferenceCategory;
  private static final String  VOICE_NOTIFICATION_SETTINGS= "voicemail_notification_settings";
  //*/
  ...
  public void onResume() {
    ...
    //*/ freeme.liqiang, 20180331. redesign voicemail settings
    mVoicemailSettingPreferenceCategory = (PreferenceCategory) prefSet.findPreference(VOICE_NOTIFICATION_SETTINGS);
    //*/
    ...
    if (omtpVvmCarrierConfigHelper.isValid()) {
      ...
      /*/
      mVoicemailSettingPreferenceCategory.removePreference(voicemailVisualVoicemail);
      mVoicemailSettingPreferenceCategory.removePreference(autoArchiveSwitchPreference);
      mVoicemailSettingPreferenceCategory.removePreference(voicemailChangePinPreference);
      //*/
    }
    ...
    //*/ freeme.liqiang, 20180321. add back title
    advancedSettingsIntent.putExtra(FreemeActionBarUtil.EXTRA_NAVIGATE_UP_TITLE_TEXT, getString(R.string.voicemail));
    //*/
