...
public class CallAudioRouteStateMachine extends StateMachine {
    ...
    private void setSpeakerphoneOn(boolean on) {
        ...
        /** M: When user switch audio from speaker to bluetooth using buletoothHeadset button,
        * AudioManager will trun off speaker before Teleom Service. Then Telecom Service will get
        * mAudioManager.isSpeakerPhoneOn(): false; So, we should always notifySpeckerphne when
