...
public class ParcelableCallUtils {
    ...
    public static ParcelableCall toParcelableCall(
        ...
        properties |= call.getGttEventExt().getGttProperties();
        properties |= call.getRttEventExt().getRttProperties();
        ...
        /*/ freeme.zhaozehong, 20180404. all accounts can use SMS to reject incoming call
        ...
        // M: fix CR:ALPS03447345,hold conference call,connect time will reset.
