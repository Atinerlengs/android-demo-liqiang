...
public class CallAudioModeStateMachine extends StateMachine {
    ...
    private class RingingFocusState extends BaseState {
        ...
        public void enter() {
            ...
            //*/ freeme.zhaozehong, 20180728. Always request the audio focus when incoming call.
            // reference Android N solution
            if (true) {
...
//            mCallAudioManager.setCallAudioRouteFocusState(CallAudioRouteStateMachine.ACTIVE_FOCUS);
            ...
            /// M: support 3G VT @{
            if (MtkUtil.is3GVtEnabled()) {
                Call fgCall = mCallAudioManager.getForegroundCall();
                if(fgCall != null && fgCall.is3GVt()) {
     ...
     */
    public void set3GVtSpeechFlag(Boolean isUp) {
        if (!MtkUtil.is3GVtEnabled()) {
            return;
        }
        if (isUp) {
            Log.d(LOG_TAG, "[setAudioMode]SetVTSpeechCall=1 under 3G VT");
