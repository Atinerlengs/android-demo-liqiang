...
public class TestInCallServiceImpl extends InCallService {
    ...
    public IBinder onBind(Intent intent) {
        // M: Create MtkTelecomTestappsGlobals and set reference. @{
        MtkTelecomTestappsGlobals.createInstance(this);
        MtkTelecomTestappsGlobals.getInstance().setInCallServiceImpl(this);
        // @}
