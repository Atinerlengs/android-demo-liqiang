...
public class TestCallActivity extends Activity {
    ...
    /*
     * M: RTT downgrade action.
     */
    public static final String ACTION_REMOTE_RTT_DOWNGRADE =
            "android.telecom.testapps.ACTION_REMOTE_RTT_DOWNGRADE";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        // M: RTT downgrade action. @{
        } else if (ACTION_REMOTE_RTT_DOWNGRADE.equals(action)) {
            CallNotificationReceiver.remoteRttDowngrade(this);
        // @}
        } else {
