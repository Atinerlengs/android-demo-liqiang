...
import com.mediatek.server.telecom.ext.DefaultRttEventExt;
...
public class InCallControllerTests extends TelecomTestCase {
    ...
    public void setUp() throws Exception {
        ...
        /// M: Fix ParcelableCallUtils NPE of calling call.getGttEventExt().getGttProperties() @{
        when(mMockCall.getGttEventExt()).thenReturn(new DefaultGttEventExt());
        when(mMockCall.getRttEventExt()).thenReturn(new DefaultRttEventExt());
        /// @}
