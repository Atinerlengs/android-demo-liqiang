    ...
    public class FakeApplicationContext extends MockContext {
        ...
        public Object getSystemService(String name) {
            switch (name) {
                ...
                /*
				 * M: Fix auto test JE casued by Toast.shwo.
				 * CallLogManager will show call duration toast when disconnect call, and Toast.shwo()
				 * will get a null pointer exception when geting LayoutInfalter.
				 */
