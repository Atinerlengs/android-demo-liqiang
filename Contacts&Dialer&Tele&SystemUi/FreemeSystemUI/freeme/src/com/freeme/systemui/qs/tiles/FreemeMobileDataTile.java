...
public class FreemeMobileDataTile extends QSTileImpl<SignalState> {
    ...
    //*/ freeme.gouzhouping, 20180323. FreemeAppTheme, qs container.
     ...
     */
    public FreemeMobileDataTile(QSHost host) {
        super(host);
    ...
    public CharSequence getTileLabel() {
        mTileLabel = mContext.getString(R.string.freeme_data_connection);
        return mTileLabel;
    }
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        /*/ freeme.gouzhouping, 20180331. FreemeAppTheme, quicksettings.
        state.state = mConnected ? Tile.STATE_ACTIVE : Tile.STATE_INACTIVE;
        /*/
