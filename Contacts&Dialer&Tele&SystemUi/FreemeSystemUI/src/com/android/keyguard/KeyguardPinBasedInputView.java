...
public abstract class KeyguardPinBasedInputView extends KeyguardAbsKeyInputView
        ...
        implements View.OnKeyListener, View.OnTouchListener, PasswordTextView.PasswdChangeListener {
        /*/
    ...
    protected void setPasswordEntryEnabled(boolean enabled) {
        ...
        //*/ freeme.gouzhouping, 20180124. FreemeAppTheme, keyguard.
        updateBackVisibility(TextUtils.isEmpty(getPasswordText()));
        //*/
    }
    ...
    protected void onFinishInflate() {
        ...
        //*/ freeme.gouzhouping, 20180124. FreemeAppTheme, keyguard.
        mPasswordEntry.setChangeListener(this);
        mBackButton = findViewById(R.id.back_button);
        mBackButton.setLongClickable(false);
        ...
        updateBackVisibility(!mPasswordEntry.isEnabled());
        //*/
    ...
    private void updateBackVisibility(boolean isBack) {
        if (isBack) {
    ...
    public void onCharAppend() {
        updateBackVisibility(TextUtils.isEmpty(getPasswordText()));
        // auto unlock.
        if (!isSimPinVerifyFailed()) {
            verifyPasswordAuto();
        }
    }

    @Override
    protected void resetKgMessage() {
        // do nothing
    }

    abstract public boolean isSimPinVerifyFailed();
    //*/

    //*/ freeme.gouzhouping, 20180205. FreemeAppTheme, fp.
    @Override
    protected boolean getPasswordEntryEnabledState() {
