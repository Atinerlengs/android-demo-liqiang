...
public class KeyguardPatternView extends LinearLayout implements KeyguardSecurityView,
    ...
    private void displayDefaultSecurityMessage() {
        //*/ freeme.gouzhouping, 20180127. FreemeAppTheme, keyguard.
        mSecurityMessageDisplay.setMessage(R.string.freeme_keyguard_ptn_instructions);
        /*/
    ...
    private void handleAttemptLockout(long elapsedRealtimeDeadline) {
        ...
        mCountdownTimer = new CountDownTimer(secondsInFuture * 1000, 1000) {
            ...
            public void onFinish() {
                ...
                displayDefaultSecurityMessage();
                /*/
                mSecurityMessageDisplay.setMessage(mContext.getString(R.string.kg_prompt_reason_timeout_pattern));
                //*/
            }
    ...
    public void startAppearAnimation() {
        /*/ freeme.gouzhouping, 20180918. keyguard animation.
        ...
        if (!AnimUtils.startEnterSecurityViewAnimation(this, animFinishRunner)) {
            setAlpha(1.0f);
            setTranslationY(mAppearAnimationUtils.getStartTranslation());
            AppearAnimationUtils.startTranslationYAnimation(this, 0, 500,
                    0.0f, mAppearAnimationUtils.getInterpolator());
            mAppearAnimationUtils.startAnimation2d(
                    mLockPatternView.getCellStates(),
                    animFinishRunner, this);
    ...
    public boolean startDisappearAnimation(final Runnable finishRunnable) {
        ...
        if (AnimUtils.startExitSecurityViewAnimation(this, finishRunnable)) {
            return true;
        }
        AppearAnimationUtils.startTranslationYAnimation(this, 0,
                (long) (300 * durationMultiplier),
                -mDisappearAnimationUtils.getStartTranslation(),
                mDisappearAnimationUtils.getInterpolator());

        mDisappearAnimationUtils.startAnimation2d(mLockPatternView.getCellStates(),
                animFinishRunner, KeyguardPatternView.this);
        //*/
        if (!TextUtils.isEmpty(mSecurityMessageDisplay.getText())) {
    ...
    public void showHintView() {
        if (mFingerprintHintView != null && mLockPatternView.isEnabled()) {
