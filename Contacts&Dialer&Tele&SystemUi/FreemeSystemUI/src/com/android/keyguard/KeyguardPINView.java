...
public class KeyguardPINView extends KeyguardPinBasedInputView {
    ...
    protected void resetState() {
        ...
        mSecurityMessageDisplay.setMessage(R.string.freeme_keyguard_pin_instructions);
        /*/
    ...
    public void startAppearAnimation() {
        ...
        if (!appearAnimation(animFinishRunner)) {
            setAlpha(1f);
            setTranslationY(mAppearAnimationUtils.getStartTranslation());
            AppearAnimationUtils.startTranslationYAnimation(this, 0, 500,
                0, mAppearAnimationUtils.getInterpolator());
            mAppearAnimationUtils.startAnimation2d(mViews, animFinishRunner);
        }
        //*/
    }
    ...
    public boolean startDisappearAnimation(final Runnable finishRunnable) {
        ...
        if (disappearAnimation(animFinishRunner)) {
            return true;
        }
        //*/
        setTranslationY(0);
        ...
        /*/
        mDisappearAnimationUtils.startAnimation2d(mViews, animFinishRunner);
        //*/
        return true;
    }
