...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    public int getLayoutIdFor(SecurityMode securityMode) {
        switch (securityMode) {
            //*/ freeme.gouzhouping, 20180124. FreemeAppTheme, keyguard.
            case Pattern: return R.layout.freeme_keyguard_pattern_view;
            case PIN: return R.layout.freeme_keyguard_pin_view;
            /*/
            ...
            case SimPinPukMe4:
                //*/ freeme.gouzhouping, 20180124. FreemeAppTheme, keyguard.
                return R.layout.freeme_keyguard_sim_pin_puk_me_view;
                /*/
    ...
    public void showFingerprintHintView() {
        if (mCurrentSecuritySelection != SecurityMode.None) {
            if (mCurrentSecuritySelection == SecurityMode.Pattern) {
                ((KeyguardPatternView) getSecurityView(mCurrentSecuritySelection)).showHintView();
            } else if (mCurrentSecuritySelection == SecurityMode.Password
                    || mCurrentSecuritySelection == SecurityMode.PIN) {
                ((KeyguardAbsKeyInputView) getSecurityView(mCurrentSecuritySelection)).showHintView();
            }
        }
    }
    ...
    public void hideFingerprintHintView() {
        if (mCurrentSecuritySelection != SecurityMode.None) {
            if (mCurrentSecuritySelection == SecurityMode.Pattern) {
                ((KeyguardPatternView) getSecurityView(mCurrentSecuritySelection)).hideHintView();
            } else if (mCurrentSecuritySelection == SecurityMode.Password
                    || mCurrentSecuritySelection == SecurityMode.PIN) {
                ((KeyguardAbsKeyInputView) getSecurityView(mCurrentSecuritySelection)).hideHintView();
            }
        }
    }
    //*/
