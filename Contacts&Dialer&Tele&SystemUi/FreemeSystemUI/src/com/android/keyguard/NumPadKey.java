...
public class NumPadKey extends ViewGroup {
    ...
    protected NumPadKey(Context context, AttributeSet attrs, int defStyle, int contentResource) {
        ...
        //*/ freeme.gouzhouping, 20180329. FreemeAppTheme, keyguard.
        mDigitText.setTextColor(getResources().getColor(R.color.freeme_kg_pin_digit_text_color));
        mKlondikeText.setTextColor(getResources().getColor(R.color.freeme_kg_pin_Klondike_text_color));
        //*/
