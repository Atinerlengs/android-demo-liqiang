...
public class VolumeDialogImpl implements VolumeDialog, TunerService.Tunable {
    ...
    private void initDialog() {
        ...
        //*/ freeme.gouzhouping, 20180123. FreemeAppTheme, volumedialog.
        mDialog.setContentView(R.layout.freeme_volume_dialog);
        /*/
        ...
        if (mRows.isEmpty()) {
            addRow(AudioManager.STREAM_MUSIC,
                    /*/ freeme.lishoubo, 20180207. FreemeAppTheme, volumedialog.
                    R.drawable.ic_volume_media, R.drawable.ic_volume_media_mute, true);
                    /*/
                    R.drawable.freeme_ic_volume_media, R.drawable.freeme_ic_volume_media_mute, true);
                    //*/
            if (!AudioSystem.isSingleVolume(mContext)) {
                addRow(AudioManager.STREAM_RING,
                        ...
                        /*/
                        R.drawable.freeme_ic_volume_ringer, R.drawable.ic_volume_ringer_mute, true);
                        //*/
                addRow(AudioManager.STREAM_ALARM,
                        /*/ freeme.lishoubo, 20180207. FreemeAppTheme, volumedialog.
                        R.drawable.ic_volume_alarm, R.drawable.ic_volume_alarm_mute, false);
                        /*/
                        R.drawable.freeme_ic_volume_alarm, R.drawable.freeme_ic_volume_alarm_mute, false);
                        //*/
    ...
    private void initRow(final VolumeRow row, final int stream, int iconRes, int iconMuteRes,
        ...
        //*/ freeme.gouzhouping, 20180123. FreemeAppTheme, volumedialog.
        row.view = mDialog.getLayoutInflater().inflate(R.layout.freeme_volume_dialog_row, null);
        /*/
        ...
        row.view.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (!mDragging && event.getActionMasked() == MotionEvent.ACTION_DOWN
                        ...
                        /*/
                        && event.getY () >= mSliderHitRect.top && event.getY () <= mSliderHitRect.bottom) {
                        //*/
                    mDragging = true;
                }
                if (mDragging) {
                    ...
                    if (row.stream == AudioManager.STREAM_RING) {
                        ...
                        if (mState.ringerModeInternal == AudioManager.RINGER_MODE_NORMAL) {
                            if (hasVibrator) {
                                ...
                                //*/ freeme.songyan, 20181009. synchronous volume bar.
    ...
    private void updateDialogBottomMarginH() {
        ...
        if (bottomMargin != mlp.bottomMargin) {
            ...
            mlp.topMargin = NotchUtils.hasNotch() ? NotchUtils.getNotchHeight() : 0;
            //*/
    ...
    private void updateVolumeRowH(VolumeRow row) {
        ...
        final int iconRes =
                ...
                /*/
                isRingVibrate ? R.drawable.freeme_ic_volume_ringer_vibrate
                //*/
        ...
        row.iconState =
                ...
                /*/
                iconRes == R.drawable.freeme_ic_volume_ringer_vibrate ? Events.ICON_STATE_VIBRATE
                //*/
    ...
    private void updateVolumeRowSliderTintH(VolumeRow row, boolean isActive) {
        ...
        /*/ freeme.lishoubo, 20180228. FreemeAppTheme, volumedialog.
        ...
        /*/
        final Drawable drawable = row.slider.isEnabled() ? mContext.getDrawable(R.drawable.freeme_systemui_seekbar_thumb)
                : mContext.getDrawable(R.drawable.freeme_systemui_seekbar_thumb);
        if (drawable == row.cachedDrawable) return;
        row.cachedDrawable = drawable;
        row.slider.setThumb (drawable);
        //*/
    }
