...
import com.freeme.recents.recentslib.data.repository.RecentsRepository;
...
public class SystemUIApplication extends Application implements SysUiServiceProvider {
    ...
    public void onCreate() {
        ...
        //*/ freeme.lishoubo, 20180125. recents surface.
        mExecutor = JobExecutor.getInstance();
        mMainHandler = new Handler(Looper.getMainLooper());
        sSystemServicesProxy = SystemServicesProxy.getInstance(this);
        mRepository = RecentsRepository.getInstance(this, sSystemServicesProxy);
        //*/
    }
    ...
    public SystemServicesProxy getSystemServices() {
