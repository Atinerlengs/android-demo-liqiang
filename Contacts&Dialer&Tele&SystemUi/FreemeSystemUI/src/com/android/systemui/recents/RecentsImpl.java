...
public class RecentsImpl implements ActivityOptions.OnAnimationFinishedListener {
    ...
    //*/freeme.lishoubo, 20180129. recents surface.
    public final static String FREEME_RECENTS_ACTIVITY = "com.freeme.recents.presentation.view.activity.RecentsActivity";
    //*/
    ...
    public void hideRecents(boolean triggeredFromAltTab, boolean triggeredFromHomeKey) {
        ...
        if (triggeredFromHomeKey) {
            FreemeHideRecentsEvent event = new FreemeHideRecentsEvent(true);
            event.force = true;
            FreemeEventBus.getDefault().post(event);
        }
        //*/
    }
    ...
    private void startRecentsActivity(ActivityOptions opts,
        ...
        /*/
        intent.setClassName(RECENTS_PACKAGE, FREEME_RECENTS_ACTIVITY);
        //*/
        ...
        hideMenuEvent.addPostAnimationCallback(() -> {
            /*/ freeme.gouzhouping, 20180305. Recents, optimise enter animation.
            Recents.getSystemServices().startActivityAsUserAsync(intent, opts);
            /*/
            Recents.getSystemServices().startActivityAsUserAsync(intent,
                    ActivityOptions.makeCustomAnimation(mContext, R.anim.recents_fade_in, R.anim.recents_fade_out));
            //*/
