...
import com.freeme.systemui.utils.GameModeUtils;
//*/
...
public class PowerNotificationWarnings implements PowerUI.WarningsUI {
    ...
    private void showWarningNotification() {
        ...
        //*/ freeme.gouzhouping, 20180724. GameMode.
        Bundle bundle = nb.getExtras();
        if (bundle == null) {
            bundle = new Bundle();
        }
        bundle.putBoolean(GameModeUtils.KEY_SHOULD_PEEK_IN_GAMEMODE, true);
        nb.setExtras(bundle);
        //*/
