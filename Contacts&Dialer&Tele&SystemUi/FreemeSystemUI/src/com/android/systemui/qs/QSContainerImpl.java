...
public class QSContainerImpl extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        //*/ freeme.gouzhouping, 20180117. FreemeAppTheme, qs container.
        mMinHeight = getResources().getDimensionPixelOffset(R.dimen.qs_panel_min_height);
        //*/
    }
    ...
    //*/ freeme.gouzhouping. 20180117. FreemeAppTheme, qs container.
    private int getQsMinExpansionHeight() {
        return mMinHeight + ((LayoutParams) mQSPanel.getLayoutParams()).topMargin;
    }
    //*/
}
