...
public class TileQueryHelper {
    ...
    private void addStockTiles(Handler mainHandler, Handler bgHandler) {
        ...
        String possible = mContext.getString(R.string.freeme_quick_settings_stock);
        /*/
    ...
    private void addPackageTiles(Handler mainHandler, Handler bgHandler) {
        bgHandler.post(() -> {
            ...
            //*/ freeme.gouzhouping, 20180305. FreemeAppTheme, qs container.
            String stockTiles = mContext.getString(R.string.freeme_quick_settings_stock);
            /*/
            ...
            for (ResolveInfo info : services) {
                ...
                /*/ freeme.gouzhouping, 20180517. fix third tile state error when add it to default quick settings area.
