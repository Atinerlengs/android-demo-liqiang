...
public class QSFactoryImpl implements QSFactory {
    ...
    public QSTile createTile(String tileSpec) {
        ...
        } else if (tileSpec.equals("supershot") && com.freeme.util.FreemeOption.FREEME_SUPER_SHOT) {
            return new com.freeme.systemui.qs.tiles.FreemeSuperShot(mHost);
        } else if (tileSpec.equals("mobiledata")) {
            return new com.freeme.systemui.qs.tiles.FreemeMobileDataTile(mHost);
        }
        //*/
