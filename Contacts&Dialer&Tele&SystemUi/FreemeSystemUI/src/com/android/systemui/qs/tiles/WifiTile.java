...
public class WifiTile extends QSTileImpl<SignalState> {
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        if (cb.isTransient) {
            ...
            /*/
            state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_wifi);
            //*/
            state.label = r.getString(R.string.quick_settings_wifi_label);
            ...
            /*/
            state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_wifi_disconnect);
            //*/
            state.label = r.getString(R.string.quick_settings_wifi_label);
        } else {
            /*/ Freeme.gouzhouping, 20180117. FreemeAppTheme, qs container.
    ...
    protected class WifiDetailAdapter implements DetailAdapter,
        ...
        private void updateItems() {
            ...
            if (!mSignalCallback.mInfo.enabled) {
                /*/ Freeme.lishoubo, 20180227. FreemeAppTheme, qs container .
                mItems.setEmptyState(R.drawable.ic_qs_wifi_detail_empty,
                /*/
                mItems.setEmptyState(R.drawable.freeme_ic_qs_wifi_detail_empty,
                //*/
