...
public class DataSaverTile extends QSTileImpl<BooleanState> implements
    ...
    //*/ freeme.gouzhouping, 20180326. FreemeAppTheme, qs container.
    ...
    protected void handleClick() {
        ...
        /*/
        dialog.setTitle(R.string.freeme_data_saver_enable_title);
        dialog.setMessage(R.string.freeme_data_saver_description);
        dialog.setPositiveButton(com.android.internal.R.string.data_saver_enable_button, new OnClickListener() {
            @Override
    ...
    public CharSequence getTileLabel() {
        //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, qs container.
        return mContext.getString(R.string.freeme_data_saver);
        /*/
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, qs container.
        state.label = mContext.getString(R.string.freeme_data_saver);
        /*/
        state.label = mContext.getString(R.string.data_saver);
        //*/
        state.contentDescription = state.label;
        //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, qs container.
        state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_datasaver);
        /*/
