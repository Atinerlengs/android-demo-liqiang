...
public class DndTile extends QSTileImpl<BooleanState> {
    ...
    public CharSequence getTileLabel() {
        //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, qs container.
        return mContext.getString(R.string.freeme_dnd_label);
        /*/
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        switch (zen) {
            case Global.ZEN_MODE_IMPORTANT_INTERRUPTIONS:
                ...
                /*/
                state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_dnd);
                //*/
        ...
        //*/ freeme.gouzhouping, 20180117. FreemeAppTheme, qs container.
        state.label = mContext.getString(R.string.freeme_dnd_label);
        //*/
        ...
        public View createDetailView(Context context, View convertView, ViewGroup parent) {
            mZenPanel = convertView != null ? (ZenModePanel) convertView
                    : (ZenModePanel) LayoutInflater.from(context).inflate(
                            //*/ freeme.lishoubo, 20180202. FreemeAppTheme, qs detail.
                            R.layout.freeme_zen_mode_panel, parent, false);
                            /*/
            ...
            if (convertView == null) {
                ...
                /*/
                mZenPanel.setEmptyState(R.drawable.freeme_ic_qs_dnd_detail_empty, R.string.dnd_is_off);
                //*/
            }
            updatePanel();
            return mZenPanel;
