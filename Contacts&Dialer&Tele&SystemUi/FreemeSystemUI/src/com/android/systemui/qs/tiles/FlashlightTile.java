...
public class FlashlightTile extends QSTileImpl<BooleanState> implements
        //*/ freeme.gouzhouping, 20180425. show flashlight mark words when low battery.
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (!mFlashlightController.isAvailable()) {
            ...
            /*/
            state.value = mFlashlightController.isAvailable();
            state.icon = ResourceIcon.get(R.drawable.freeme_ic_qs_flashlight);
            //*/
    ...
    private void showLowBatteryDialog() {
        SystemUIToast.makeText(mContext, mContext.getResources().getString(R.string.freeme_low_battery_flashlight_canot_use)).show();
    }
    //*/
}
