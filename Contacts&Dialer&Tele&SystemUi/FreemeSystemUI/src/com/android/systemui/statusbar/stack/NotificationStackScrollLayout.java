...
public class NotificationStackScrollLayout extends ViewGroup
    ...
    private float getAppearEndPosition() {
        ...
        /*/ freeme.xiaohui,20180510, Bug:34262
        return appearPosition + (onKeyguard() ? mTopPadding : mIntrinsicPadding);
        /*/
        return appearPosition + (onKeyguard() ? mTopPadding : (mIntrinsicPadding + getLayoutMinHeight() + mPaddingBetweenElements));
        //*/
    }
    ...
    private void setIsExpanded(boolean isExpanded) {
        ...
        if (changed) {
            ...
            if (mIsExpanded && NotchUtils.hasNotch()) {
    ...
    public void goToFullShade(long delay) {
        ...
        mNeedsAnimation = true;
        requestChildrenUpdate();
        //*/ freeme.gouzhouping, 20180120. FreemeTheme, notification view.
        mStatusBar.goToFullShade();
        //*/
    }
