...
public class NotificationContentView extends FrameLayout {
    ...
    public NotificationContentView(Context context, AttributeSet attrs) {
        ...
        /*/
        mNotificationContentMarginEnd = 0;
        //*/
    }
    ...
    //*/ freeme.biantao, 20180207. Theme.Freeme 8.1 - notification.
    public void setHeaderBackground(android.graphics.drawable.Drawable bg) {
        if (mContractedChild != null) {
            NotificationHeaderView header = mContractedWrapper.getNotificationHeader();
            if (header != null) {
                View v = header.findViewById(com.android.internal.R.id.line_divider);
                if (v != null) {
                    v.setBackground(bg);
                }
            }
