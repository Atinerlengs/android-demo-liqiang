...
public class KeyguardIndicationController {
    ...
    KeyguardIndicationController(Context context, ViewGroup indicationArea, LockIcon lockIcon,
        ...
        mInitialTextColor = context.getColor(R.color.freme_kg_fp_indication_color);
        //*/
    ...
    protected final void updateIndication() {
        ...
        if (mVisible) {
            ...
            if (!mUserManager.isUserUnlocked(userId)) {
                ...
                mTextView.setTextColor(mInitialTextColor);
            //*/ freeme.xiaohui, 20180620, FreemeLockscreen
            } else if (mPowerPluggedIn && needShowPlugedInfo()) {
            /*/
            ...
            //*/
                ...
                /*/
                switch (getKeyguardStatusViewConfig()) {
                    ...
                    case FreemeKeyguardStatusViewConfig.CONFIG_KG_STATUSVIEW_BOTTOM: {
                        boolean isFingerprint = updateMonitor.isFingerprintDetectionRunning();
                        mTextView.switchIndication(mContext.getResources().getString(
                                isFingerprint ? R.string.kg_finger_print_unlcok : R.string.keyguard_unlock));
                        break;
                    }
                }
                //*/
    ...
    protected class BaseKeyguardCallback extends KeyguardUpdateMonitorCallback {
        ...
        public void onFingerprintHelp(int msgId, String helpString) {
            ...
            //*/ freeme.gouzhouping, 20180129. FreemeAppTheme, keyguard view.
            errorColor = mContext.getColor(R.color.freme_kg_fp_indication_color);
            //*/
        ...
        public void onFingerprintError(int msgId, String errString) {
            ...
            if (mStatusBarKeyguardViewManager.isBouncerShowing()) {
                ...
                if (mLastSuccessiveErrorMessage != msgId) {
                    ...
                    /*/
                    if (!errString.equals(mContext.getString(com.android.internal.R.string.fingerprint_error_lockout))) {
                        mStatusBarKeyguardViewManager.showBouncerMessage(errString, errorColor);
                    }
                    //*/
                }
    ...
    private boolean needShowPlugedInfo() {
