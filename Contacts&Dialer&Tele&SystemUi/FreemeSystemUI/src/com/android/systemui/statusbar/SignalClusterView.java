...
public class SignalClusterView extends LinearLayout implements NetworkControllerImpl.SignalCallback,
    ...
    public SignalClusterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //*/ freeme.gouzhouping, 20180525. FreemeAppTheme, signal
        mDataUsageController = Dependency.get(NetworkController.class).getMobileDataController();
        //*/

        //*/ freeme.gouzhouping, 20180531. Notch.
        mEarSecondaryTelephonyPadding = res.getDimensionPixelSize(R.dimen.notch_secondary_telephony_padding);
    ...
    protected void onDetachedFromWindow() {
        ...
        mNetworkController.removeCallback(this);
        //*/ freeme.gouzhouping, 20180809. notch.
    ...
    private void apply() {
        ...
        if (mIsAirplaneMode) {
            ...
            //*/ freeme.gouzhouping, 20180507. FreemeAppTheme, statusbar.
            mNoSimsDark.setVisibility(View.GONE);
            ...
            //*/ freeme.gouzhouping, 20180507. FreemeAppTheme, statusbar.
            mNoSimsDark.setVisibility(View.VISIBLE);
            mNoSims.setVisibility(View.VISIBLE);
            //*/
        }
        ...
        if (mNoSimsVisible) {
            ...
            if (!Objects.equals(mSimDetected, mNoSimsCombo.getTag())) {
                ...
                if (mSimDetected && !mIsAirplaneMode) {
                    ...
                    //*/ freeme.gouzhouping, 20180313. FreemeAppTheme, signal
                    mNoSims.setImageResource(R.drawable.freeme_stat_sys_no_sims);
                    mNoSimsDark.setImageResource(R.drawable.freeme_stat_sys_no_sims);
                    /*/
    ...
    private void applyIconTint() {
        ...
        applyDarkIntensity(
                ...
                mNoSims, mNoSimsDark);
        /*/
        mNoSims.clearColorFilter();
        mNoSimsDark.clearColorFilter();
        setTint(mNoSims, DarkIconDispatcher.getTint(mTintArea, mNoSims, mIconTint));
        setTint(mNoSimsDark, DarkIconDispatcher.getTint(mTintArea, mNoSimsDark, mIconTint));
        //*/
        ...
        /*/ freeme.gouzhouping, 20180301. FreemeAppTheme, optimise wifi signal.
        applyDarkIntensity(
                DarkIconDispatcher.getDarkIntensity(mTintArea, mWifi, mDarkIntensity),
                mWifi, mWifiDark);
        /*/
        setTint(mWifi, DarkIconDispatcher.getTint(mTintArea, mWifi, mIconTint));
        //*/
    ...
    private class PhoneState {
        ...
        public void setViews(ViewGroup root) {
           ...
           ///M: Add for [Network Type and volte on Statusbar]
            ...
            //*/ freeme.gouzhouping, 20180313. FreemeAppTheme, signal.
            mDataInOut      = root.findViewById(R.id.data_inout);
            //*/
        ...
        public void setIconTint(int tint, float darkIntensity, Rect tintArea) {
            ...
            //*/ freeme.gouzhouping, 20180313. FreemeAppTheme, signal
            setTint(mDataInOut, DarkIconDispatcher.getTint(tintArea, mDataInOut, tint));
            //*/
        }
        ...
        private void setVolteIcon() {
            if (mVolteIcon == 0) {
                ...
                //*/ freeme.gouzhouping, 20180809. notch.
                if (NotchUtils.hasNotch()) {
                    mVolteType.setVisibility(NotchUtils.isLandscape(mContext) || isQuickNotch()
    ...
    private void showDataInout(ImageView mDataInout) {
        ...
        if (0 == mobileTypeId || mBlockMobile) {
            ...
            mDataInout.setImageResource(isMobileConnected(mContext)
                    ...
                    && mDataUsageController.isMobileDataSupported() ? getDataInoutResource(dataActivity) : 0);
            mDataInout.setVisibility(View.VISIBLE);
        }
    }
    ...
    //*/ freeme.gouzhouping, 20180809. notch.
    private int mEarSecondaryTelephonyPadding;
    private boolean mIsQuickNotch;
    ...
    private void updateWifiVisibility() {
        int vis = mWifiGroup.getVisibility();
        if (!hasTwoSimCards()) {
            mWifiGroup.setVisibility(vis);
        } else if (NotchUtils.hasNotch() && hasTwoSimCards() && !isQuickNotch()) {
            mWifiGroup.setVisibility(NotchUtils.isLandscape(mContext) ? vis : View.GONE);
        }
    }

    private boolean hasTwoSimCards() {
        boolean hasSim1 = SIMHelper.isSimInsertedBySlot(mContext, PhoneConstants.SIM_ID_1);
        boolean hasSim2 = SIMHelper.isSimInsertedBySlot(mContext, PhoneConstants.SIM_ID_2);
        return hasSim1 && hasSim2;
    }

    public void setQuickNotch(boolean quickNotch) {
        mIsQuickNotch = quickNotch;
    }

    private boolean isQuickNotch() {
        return mIsQuickNotch;
    }
    //*/
}
