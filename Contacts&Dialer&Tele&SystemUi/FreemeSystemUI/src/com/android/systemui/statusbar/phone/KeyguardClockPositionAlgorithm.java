...
public class KeyguardClockPositionAlgorithm {
    ...
    private int mClockViewMarginTop;
    //*/
    ...
    public void loadDimens(Resources res) {
        ...
        //*/ freeme.gouzhouping, 20180115. FreemeAppTheme, keyguard view.
        mClockViewMarginTop = res.getDimensionPixelSize(R.dimen.keyguard_clockview_margintop);
        //*/
    }
    ...
    public void run(Result result) {
        ...
        /*/
        float scale = getClockScale(result.stackScrollerPadding,
                result.clockY,y + getClockNotificationsPadding() + mKeyguardStatusHeight);
        result.clockY = (int)(y * scale);
        result.clockScale = 1;
        result.clockAlpha = getClockAlpha(scale);
        //*/
