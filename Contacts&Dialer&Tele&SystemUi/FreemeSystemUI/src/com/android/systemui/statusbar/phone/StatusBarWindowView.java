...
public class StatusBarWindowView extends FrameLayout {
    ...
    public StatusBarWindowView(Context context, AttributeSet attrs) {
        ...
        //*/ freeme.gouzhouping, 20180828. OneStep.
        if (FreemeOption.FREEME_ONESTEP_SUPPORT) {
            mOneStepXStartThreshold = context.getResources()
                    .getDimensionPixelSize(R.dimen.sidebar_start_threshold_x_a);
        }
        //*/
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (FreemeOption.FREEME_ONESTEP_SUPPORT
                ...
                && (ev.getRawX() <= mOneStepXStartThreshold
                    || ev.getRawX() >= getMeasuredWidth() - mOneStepXStartThreshold)) {
            return false;
        }
        //*/
