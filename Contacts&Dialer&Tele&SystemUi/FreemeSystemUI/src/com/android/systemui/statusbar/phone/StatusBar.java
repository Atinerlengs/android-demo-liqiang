...
//*/ freeme.zhiwei.zhang, 20180117. Navigation - Collapsable.
...
import com.freeme.systemui.blur.WindowBlurView;
import com.freeme.systemui.blur.WindowBlurView.BlurStateListener;
//*/

//*/  freeme.xiaohui, 20180416. FreemeLockScreen
import com.freeme.lockscreen.FreemeLockscreenHostManager;
//*/
...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        //*/ freeme.gouzhouping, 20180122. FreemeAppTheme, notification view.
        mDelete = (ImageView) mNotificationPanel.findViewById(R.id.delete);
    ...
    protected void makeStatusBarView() {
        ...
        FragmentHostManager.get(mStatusBarWindow)
                .addTagListener(CollapsedStatusBarFragment.TAG, (tag, fragment) -> {
                    ...
                    if (!NotchUtils.hasNotch()) {
                        mFreemeBatteryManager = new FreemeBatteryManager(mContext, mBatteryController,
                                mStatusBarView, mKeyguardStatusBar);
                    }
                    //*/
                }).getFragmentManager()
                .beginTransaction()
        ...
        //*/ freeme.xiaohui, 20180808, FreemeLockscreen
        mBackdropBack = (ImageView) mBackdrop.findViewById(R.id.keyguard_backdrop_back);
        mLockscreenHostManager = new FreemeLockscreenHostManager(mContext, mHandler);
        mLockscreenHostManager.setNotificationPanel(mNotificationPanel);
        mLockscreenHostManager.addCallback(new FreemeLockscreenHostManager.HostChangedCallBack(){
            @Override
            public void onUnlock(Intent target) {
                ...
                if (target != null) {
                    ...
                    try {
                        ...
                        Log.d(TAG, "onUnlock Error:" + ex.toString());
                    }
                }
            }
        });
        mLockscreenHostManager.initLockscreen(mBackdrop);
        /*/
        ...
        mBatteryController.addCallback(new BatteryStateChangeCallback() {
            ...
            public void onBatteryLevelChanged(int level, boolean pluggedIn, boolean charging) {
                // noop
                //*/ freeme.xiaohui,  20180816, FreemeLockscreen
                mLockscreenHostManager.onBatteryLevelChanged(level);
                //*/
            }
        });
        ...
        //*/ freeme.xiaohui, 20180808, FreemeLockscreen
        mLockscreenHostManager.setScrimController(mScrimController);
        mLockscreenHostManager.createLockscreenHost();
        //*/
        ...
        if (container != null) {
            ...
            fragmentHostManager.addTagListener(QS.TAG, (tag, f) -> {
                ...
                if (qs instanceof QSFragment) {
                    ...
                    //*/ freeme.chenming, 20180227. FreemeAppTheme, blur view
                    mQSCustomizer = ((QSFragment) qs).getCustomizer();
                    //*/

                    //*/ freeme.gouzhouping, 20180718. Notch.
                    if (NotchUtils.hasNotch()) {
                        mNotchStatusBar = (NotchStatusBar) ((ViewStub) mNotificationPanel.findViewById(R.id.notch_qs_header_status_bar)).inflate();
                        FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) mNotchStatusBar.getLayoutParams();
                        lp.height = NotchUtils.getNotchHeight();
                        mNotchStatusBar.setLayoutParams(lp);
                        mFreemeBatteryManager = new FreemeBatteryManager(mContext, mBatteryController,
                                mStatusBarView, mKeyguardStatusBar, mNotchStatusBar);
                        mNotchIconManager = new StatusBarIconController.TintedIconManager(mNotchStatusBar.findViewById(R.id.statusIcons));
                        Dependency.get(StatusBarIconController.class).addIconGroup(mNotchIconManager);
                    }
                    //*/
                }
            });
    ...
    protected void createNavigationBar() {
        ...
        updateNavigationBar(Settings.System.getIntForUser(mContext.getContentResolver(),
                com.freeme.provider.FreemeSettings.System.FREEME_NAVIGATION_BAR_COLLAPSED,
    ...
    protected void inflateStatusBarWindow(Context context) {
        ...
        if (NotchUtils.hasNotch())
            mStatusBarWindow = (StatusBarWindowView) View.inflate(context,
                R.layout.freeme_notch_super_status_bar, null);
        else
        //*/
        mStatusBarWindow = (StatusBarWindowView) View.inflate(context,
    ...
    protected void startKeyguard() {
        ...
        //*/ freeme.xiaohui, 20180808, FreemeLockscreen
        mLockscreenHostManager.setStatusBarKeyguardViewManager(mStatusBarKeyguardViewManager);
        //*/
    ...
    protected boolean toggleSplitScreenMode(int metricsDockAction, int metricsUndockAction) {
        ...
        //*/ freeme.zhaozehong, 20180828. GameMode
        if (com.freeme.systemui.utils.GameModeUtils.getInstance(mContext).isLockRecentKey()) {
            // the game mode wants to handle the recent key
            return false;
        }
        //*/

        //*/ freeme.gouzhouping, 20181010. one step.
        com.freeme.internal.app.FreemeOneStepManager oneStepManager =
                com.freeme.internal.app.FreemeOneStepManager.from(mContext);
        if (oneStepManager != null && oneStepManager.isOneStepMode()) {
            // in one step mode, it is forbidden to enter split screen.
            return false;
        }
        //*/
    ...
    private void updateClearAll() {
        ...
        /*/
        if (mDelete != null && mNotificationPanel != null) {
            boolean showDismissView = (mState != StatusBarState.SHADE
                    || !hasActiveClearableNotifications() || mQSPanel.isShowingCustomize())
                    ? false : !mNotificationPanel.isPanelVisibleBecauseOfHeadsUp();
            mDelete.setVisibility(!showDismissView ? View.GONE : View.VISIBLE);
        }
        //*/
    }
    ...
    public void updateMediaMetaData(boolean metaDataChanged, boolean allowEnterAnimation) {
        ...
        if (ENABLE_LOCKSCREEN_WALLPAPER && artworkDrawable == null) {
            ...
            if (lockWallpaper != null) {
                ...
                if (com.freeme.systemui.utils.SuperPowerUtils.isSuperPowerModeOn(mContext)) {
                    ColorDrawable mBlackLockWallPaper = new ColorDrawable(Color.BLACK);
                    artworkDrawable = mBlackLockWallPaper;
                }
                //*/
        ...
        /*/ freeme.xiaohui, 2018.04.17, FreemeLockscreen
        if ((hasArtwork || DEBUG_MEDIA_FAKE_ARTWORK)
                ...
                && !hideBecauseOccluded) {
        //*/
        if ((hasArtwork || DEBUG_MEDIA_FAKE_ARTWORK || mLockscreenHostManager.isShowLockscreenView())
                && (mState != StatusBarState.SHADE || allowWhenShade)
                && mFingerprintUnlockController.getMode()
                != FingerprintUnlockController.MODE_WAKE_AND_UNLOCK_PULSING
                && !hideBecauseOccluded) {
        //*/
            ...
            if (metaDataChanged) {
                //*/ Freeme.xiaohui,20180502, FreemeLockscreen
                mLockscreenHostManager.showLockscreenView();
                if (mLockscreenHostManager.notShowWallPapers()) {
                    // noop
                } else
                //*/
                ...
                if (mScrimSrcModeEnabled) {
                    ...
                    /*/
                    mBackdropFront.getDrawable().mutate().setXfermode(mSrcXferMode);
                    //*/
                }
            ...
            if (mBackdrop.getVisibility() != View.GONE) {
                ...
                if (mFingerprintUnlockController.getMode()
                    ...
                    //*/ Freeme.xiaohui.20180427, FreemeLockscreen
                    mLockscreenHostManager.hideLockscreenView();
                    //*/
                } else {
                    mStatusBarWindowManager.setBackdropShowing(false);
                    mBackdrop.animate()
    ...
    public void onHeadsUpUnPinned(ExpandableNotificationRow headsUp) {
        //*/ freeme.xiaohui, 20180516, headsup
        headsUp.setHeadsUp(false);
        //*/
    }
...
///@}
    ...
    private void dismissKeyguardThenExecute(OnDismissAction action, Runnable cancelAction,
        ...
        if (mStatusBarKeyguardViewManager.isShowing()) {
            //*/ freeme.songyan, 20180911. collapse panels.
            mStatusBarKeyguardViewManager.animateCollapsePanels(1.1f);
            //*/
    ...
    public void destroy() {
        ...
        //*/ freeme.gouzhouping, 20180718. Notch.
        if (NotchUtils.hasNotch()) {
            Dependency.get(StatusBarIconController.class).removeIconGroup(mNotchIconManager);
        }
        //*/
        //*/ freeme.xiaohui, 20180810, FreemeLockscreen
        mLockscreenHostManager.destroyLockscreenHost();
        //*/
    }
    ...
    protected void updateKeyguardState(boolean goingToFullShade, boolean fromShadeLocked) {
        ...
        //*/ freeme.xiaohui,20180419, FreemeLockscreen
        mLockscreenHostManager.resetLockscreenStatus(mState);
        //*/
    }
    ...
    public boolean onBackPressed() {
        ...
        if (mQSPanel != null && mQSPanel.isShowingCustomize()) {
            if (mNotificationPanel.isQsDetailShowing()) {
                mNotificationPanel.closeQsDetail();
            } else {
                mNotificationPanel.animateCloseQs();
    ...
    protected void showBouncer() {
        ...
        //*/ freeme.xiaohui, 20180705, bouncer blur
        if (mBouncerShowing) {
            mBlurView.setShowBlur(true);
            mBlurView.setProgress(1.0f);
            setViewVisibility(mBlurView, View.VISIBLE);
        }
        //*/
    }
    ...
    public void setBarState(int state) {
        ...
        //*/ freeme.xiaohui, 20180705, bouncer blur
        if (mState == StatusBarState.KEYGUARD || mState == StatusBarState.SHADE_LOCKED) {
            mBlurView.onKeyguardStateChanged(true);
        } else {
            mBlurView.onKeyguardStateChanged(false);
        }
        //*/
    }
    ...
    public boolean onDraggedDown(View startingChild, int dragLengthY) {
        ...
        if (mState == StatusBarState.KEYGUARD
                ...
                && !mNotificationPanel.isForibSlide()) {
        /*/
        if (mState == StatusBarState.KEYGUARD
                && hasActiveNotifications() && (!isDozing() || isPulsing())) {
        //*/
    ...
    ScreenLifecycle.Observer mScreenObserver = new ScreenLifecycle.Observer() {
        ...
        public void onScreenTurnedOn() {
            ...
            //*/ freeme.xiaohui, 20180810, FreemeLockscreen
            mLockscreenHostManager.onLockscreenTurnedOn();
            //*/
        }
        ...
        public void onScreenTurnedOff() {
            ...
            //*/ freeme.xiaohui, 20180810, FreemeLockscreen
            mLockscreenHostManager.onLockscreenTurnedOff();
            //*/
        }
    };
    ...
    private RemoteViews.OnClickHandler mOnClickHandler = new RemoteViews.OnClickHandler() {
        ...
        private boolean handleRemoteInput(View view, PendingIntent pendingIntent, Intent fillInIntent) {
            ...
            LinearLayout actionsLinearLayout = null;
            //*/
            ...
            while (p != null) {
                if (p instanceof View) {
                    ...
                    if (pv instanceof LinearLayout) {
                        actionsLinearLayout = (LinearLayout) pv;
                    }
                    //*/
            ...
            //*/ freeme.biantao, 20180224. Theme.Freeme 8.1 - notification.
            if (actionsLinearLayout != null) {
                riv.setActionListLayout(actionsLinearLayout);
                actionsLinearLayout.setVisibility(View.INVISIBLE);
            }
            //*/
    ...
    protected void updateRowStates() {
        ...
        while(!stack.isEmpty()) {
            ...
            if (suppressedSummary
                    ...
                    || (com.freeme.systemui.utils.SuperPowerUtils.isSuperPowerModeOn(mContext) && onKeyguard)
                    //*/
                    //*/ freeme.xiaohui,20180511, FreemeLockscreen
                    || (onKeyguard && (mLockscreenHostManager.isConfigNotifyNotVisible()))
                    //*/
    ...
    /*/
    public boolean shouldPeek(Entry entry) {
    //*/
    ...
    //*/ freeme.zhiwei.zhang, 20180117. Navigation - Collapsable.
    private static final int NAVIGATION_BAR_SHOW_DELAY_MS = 100;

    public void updateNavigationBar(boolean navCollapsed) {
        if (!FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)
                || mNavigationBarView == null) {
            return;
        }

        final int navMode = Settings.System.getIntForUser(mContext.getContentResolver(),
                com.freeme.provider.FreemeSettings.System.FREEME_NAVIGATION_BAR_MODE,
                0, UserHandle.USER_CURRENT);
        final boolean navCollapsedForce =
                navMode != com.freeme.policy.FreemeNavigation.Mode.COLLAPSABLE;

        try {
            mWindowManagerService.updateNavigationBar(navCollapsed || navCollapsedForce);
        } catch (RemoteException ex) {
            ex.printStackTrace();
            return;
        }

        if (navCollapsed || navCollapsedForce) {
            mNavigationBarView.setVisibility(View.GONE);
        } else {
            mHandler.postDelayed(() ->
                    mNavigationBarView.setVisibility(View.VISIBLE), NAVIGATION_BAR_SHOW_DELAY_MS);
        }
    }

    public View.OnClickListener mCollapsableButtonClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private void initBlurView() {
        getScreenSize();
        mBlurView = (WindowBlurView) mStatusBarWindow.findViewById(R.id.blur);
        mBlurView.setBlurRadius(10);
        mBlurView.setScale(0.3f);
        mBlurView.setScreenLayer(0, 159999);
        mBlurView.setRrefreshDuration(0);
        mBlurView.setMaskDrawable(new ColorDrawable(mContext.getResources().getColor(R.color.freeme_qs_blur_mask_color)));
        mBlurView.setBackDropView(mBackdrop);
        mBlurView.setBlurStateListener(new BlurStateListener() {
            @Override
            ...
            public void onBlurSuccess(Bitmap blurBitmap) {
                if (mQSCustomizer != null) {
                    mQSCustomizer.setBlur(new BitmapDrawable(mContext.getResources(), blurBitmap));
                }
                mBrightnessMirrorController.setBlur(blurBitmap);
            }
        });
    }
    ...
    public void updateBlurView() {
        int i = View.GONE;
        float showHeight = ((float) mScreenHeight) * 0.0f;
        float showHeightDeleteView = ((float) mScreenHeight) * 0.1f;

        if (mBlurView != null && mDelete != null) {
            if (mState != StatusBarState.SHADE) {
                if (mNotificationPanel.getQsExpansionFraction() >= 0.0f
                        && mSlideHeight > 0.0f) {
                    float alpha = 1.0f;
                    if (mNotificationPanel.getExpandedHeight() < showHeight) {
                        alpha = 0.0f;
                    } else if (mNotificationPanel.getExpandedHeight() < showHeightDeleteView) {
                        alpha = (mNotificationPanel.getExpandedHeight() - showHeight) / (showHeightDeleteView - showHeight);
                    }
                    mBlurView.setShowBlur(true);
                    mBlurView.setProgress(alpha);
                    setViewVisibility(mBlurView, mShowMirror ? View.GONE : View.VISIBLE);
                } else {
                    if (!isBouncerShowing()) {
                        mBlurView.setShowBlur(false);
                        mBlurView.setProgress(0.0f);
                        setViewVisibility(mBlurView, View.GONE);
                    }
                }
                //FIXME:
//                if (mNotificationPanel.isUseGgStatusView()) {
//                    if (mBlurView.getVisibility() == 0) {
//                        mKeyguardStatusView.setVisibility(8);
//                    } else {
//                        mKeyguardStatusView.setVisibility(0);
//                    }
//                }
            } else if (mNotificationPanel.getExpandedHeight() > 0.0f) {
                float alpha = 1.0f;
                if (mNotificationPanel.getExpandedHeight() < showHeight) {
                    alpha = 0.0f;
                } else if (mNotificationPanel.getExpandedHeight() < showHeightDeleteView) {
    ...
    private static void setViewVisibility(View view, int visible) {
        if (view != null) {
            view.setVisibility(visible);
        } else {
            Log.w("KgViewUtils", "setViewVisibility for null View", new Exception());
        }
    }
    ...
    public void updateKeyguardBlurView(float height) {
        mSlideHeight = height;
        updateBlurView();
    }
    //*/
    ...
    //*/ freeme.xiaohui, 20180808, FreemeLockscreen
    private FreemeLockscreenHostManager mLockscreenHostManager;

    public FreemeLockscreenHostManager getLockscreenHostManager() {
        return mLockscreenHostManager;
    }
    //*/

    //*/ freeme.gouzhouping, 20180718. Notch.
    private NotchStatusBar mNotchStatusBar;
    private StatusBarIconController.TintedIconManager mNotchIconManager;
    //*/
}
