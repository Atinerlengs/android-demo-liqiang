...
public class FingerprintUnlockController extends KeyguardUpdateMonitorCallback {
        ...
        switch (mMode) {
            ...
            case MODE_SHOW_BOUNCER:
                ...
                if (!wasDeviceInteractive) {
                    ...
                    if (mStatusBarKeyguardViewManager.isOccluded()) {
    ...
    public void onFingerprintAuthFailed() {
        cleanup();
        //*/ freeme.gouzhouping, 20180202. FreemeAppTheme, fp.
        isFirScreenOnFp = true;
        //*/
    }
    ...
    public void onFingerprintError(int msgId, String errString) {
        ...
        if (msgId == FingerprintManager.FINGERPRINT_ERROR_LOCKOUT
            ...
            mStatusBar.notifyFpAuthModeChanged();
            mStatusBarKeyguardViewManager.showFingerprintHintView();
        }
    ...
    //*/ freeme.gouzhouping, 20180202. FreemeAppTheme, fp.
    private boolean isFirScreenOnFp = true;
    //*/
}
