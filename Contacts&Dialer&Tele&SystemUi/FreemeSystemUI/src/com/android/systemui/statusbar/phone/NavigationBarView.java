...
public class NavigationBarView extends FrameLayout implements PluginListener<NavGesture> {
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
        ...
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            mButtonDispatchers.put(R.id.freeme_collapsable_bar, new ButtonDispatcher(R.id.freeme_collapsable_bar));
        }
        //*/
    }
    ...
    private void updateIcons(Context ctx, Configuration oldConfig, Configuration newConfig) {
        ...
        if (oldConfig.densityDpi != newConfig.densityDpi
            ...
            //*/ freeme.zhiwei.zhang, 20180117. Navigation - Collapsable.
            mCollapsableBarIcon = getDrawable(ctx, R.drawable.ic_sysbar_collapsable_bar,
                    R.drawable.ic_sysbar_collapsable_bar_dark);
            //*/
    ...
    */
    ...
    //*/ freeme.zhiwei.zhang, 20180117. Navigation - Collapsable.
    private KeyButtonDrawable mCollapsableBarIcon;
    public ButtonDispatcher getCollapsableButton() {
        return mButtonDispatchers.get(R.id.freeme_collapsable_bar);
    }
    //*/
}
