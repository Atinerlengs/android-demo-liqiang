...
public class NavigationBarFragment extends Fragment implements Callbacks {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //*/ freeme.zhiwei.zhang, 20180118. Navigation - Key.
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            mLongPressOnHomeBehavior = getContext().getResources().getInteger(
    ...
    private void prepareNavigationBarView() {
        ...
        if (FreemeOption.Navigation.supports(FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            ...
            collapsableButton.setOnClickListener(mStatusBar.mCollapsableButtonClickListener);
        }
        //*/
    }
    ...
    private void launchFreemeAssistAction() {
        if (Settings.System.getInt(getContext().getContentResolver(),
                com.freeme.provider.FreemeSettings.System.FREEME_SUPER_POWER_SAVER_ENABLE, 0) == 1) {
            return;
        }
        try {
            ...
            getContext().startActivity(freemevoiceintent);
