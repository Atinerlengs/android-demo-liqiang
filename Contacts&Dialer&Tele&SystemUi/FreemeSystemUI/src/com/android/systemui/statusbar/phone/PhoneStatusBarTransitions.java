...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public void init() {
        ...
        /*/ freeme.gouzhouping, 20180827. statusbar state.
        mBattery = mView.findViewById(R.id.battery);
        /*/
        mBattery = mView.findViewById(R.id.freeme_battery);
        mCarrierArea = mView.findViewById(R.id.carrier_area);
        //*/
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mCarrierArea, newAlpha)
                    //*/
                    );
            if (isLightsOut(mode)) {
            ...
            mCarrierArea.setAlpha(newAlpha);
            //*/
        }
    }
