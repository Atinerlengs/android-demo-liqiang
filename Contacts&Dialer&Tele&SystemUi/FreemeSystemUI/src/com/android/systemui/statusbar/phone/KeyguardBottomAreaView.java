...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    public void launchCamera(String source) {
        ...
        //*/ freeme.gouzhouping, 20180524. FreemeAppTheme, set freeme camera default camera.
        intent.setPackage("com.freeme.camera");
        //*/
    ...
    public void setDozing(boolean dozing, boolean animate) {
        ...
        if (dozing) {
            ...
            //*/ freeme.gouzhouping, 20180129. FreemeAppTheme, keyguard view.
            mLockIcon.updateLockIconVisibility();
            /*/
    ...
    public void updateIndicationLayout() {
        if (FreemeKeyguardStatusViewConfig.sConfig != mCurrentMode) {
            indicationLayout();
        }
    }

    private void indicationLayout() {
        FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) mIndicationArea.getLayoutParams();

        switch (FreemeKeyguardStatusViewConfig.sConfig) {
            case FreemeKeyguardStatusViewConfig.CONFIG_KG_STATUSVIEW_TOP:{
                mCurrentMode = FreemeKeyguardStatusViewConfig.CONFIG_KG_STATUSVIEW_TOP;
                lp.bottomMargin = getResources().getDimensionPixelSize(R.dimen.magazine_kg_unuse_indication_area_margin_bottom);
                lp.gravity = Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL;
                break;
            }
            case FreemeKeyguardStatusViewConfig.CONFIG_KG_STATUSVIEW_BOTTOM:{
                mCurrentMode = FreemeKeyguardStatusViewConfig.CONFIG_KG_STATUSVIEW_BOTTOM;
                lp.topMargin = getResources().getDimensionPixelSize(R.dimen.magazine_kg_use_indication_area_margin_top);
                lp.gravity = Gravity.TOP | Gravity.CENTER_HORIZONTAL;
                break;
            }
        }

        mIndicationArea.setLayoutParams(lp);
    }
    //*/
}
