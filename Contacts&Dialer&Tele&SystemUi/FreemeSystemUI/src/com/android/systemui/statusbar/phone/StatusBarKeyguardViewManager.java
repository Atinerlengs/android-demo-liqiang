...
public class StatusBarKeyguardViewManager implements RemoteInputController.Callback {
    ...
    public void reset(boolean hideBouncerWhenShowing) {
        if (DEBUG) {
            Log.d(TAG, "reset() is called, mShowing = " + mShowing + " ,mOccluded = " + mOccluded
                    + "hideBouncerWhenShowing = " + hideBouncerWhenShowing);
        }
        if (mShowing) {
    ...
    public void updateStates() {
        ...
        if (com.freeme.util.FreemeOption.Navigation.supports(
                com.freeme.util.FreemeOption.Navigation.FREEME_NAVIGATION_COLLAPSABLE)) {
            navBarVisible = navBarVisible
                    && (android.provider.Settings.System.getIntForUser(mContext.getContentResolver(),
                        com.freeme.provider.FreemeSettings.System.FREEME_NAVIGATION_BAR_COLLAPSED,
                        0, android.os.UserHandle.USER_CURRENT) == 0);
        }
        //*/
    ...
    public void keyguardGoingAway() {
        ...
        mBouncer.hideFingerprintHintView();
        //*/
    }
    ...
    public void showFingerprintHintView() {
        mBouncer.showFingerprintHintView();
    }

    public int getBouncerPromptReason() {
        return mBouncer.getBouncerPromptReason();
    }
    //*/
}
