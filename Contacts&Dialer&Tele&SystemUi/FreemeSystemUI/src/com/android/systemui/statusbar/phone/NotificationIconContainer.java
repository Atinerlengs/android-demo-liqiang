...
public class NotificationIconContainer extends AlphaOptimizedFrameLayout {
    ...
    public void calculateIconTranslations() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //*/ freeme.gouzhouping, 20180820. notch.
            if (NotchUtils.hasNotch() && !NotchUtils.isLandscape(mContext) && childCount == 1) {
                int[] firstViewLoc = new int[2];
                view.getLocationOnScreen(firstViewLoc);
                if (firstViewLoc[0] + view.getWidth() >= com.freeme.util.FreemeNotchUtil.getNotchRect().left) {
                    noOverflowAfter = false;
                }
            }
            //*/
    ...
    private float getLayoutEnd() {
        ...
        if (NotchUtils.hasNotch() && !NotchUtils.isLandscape(mContext)) {
            return getActualWidth() - getActualPaddingEnd() - NotchUtils.getNotchWidth();
        }
        //*/
