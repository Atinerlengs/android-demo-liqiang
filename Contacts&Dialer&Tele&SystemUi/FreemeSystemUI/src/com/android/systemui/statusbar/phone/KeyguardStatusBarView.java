...
public class KeyguardStatusBarView extends RelativeLayout
    ...
    protected void onFinishInflate() {
        ...
        //*/ freeme.gouzhouping, 20180808. notch.
        mCarrierText = (CarrierText) findViewById(R.id.carrier_text);
        if (NotchUtils.hasNotch()) {
            mBatteryBorder = mSystemIconsContainer.findViewById(R.id.battery_border);
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        /*/ freeme.gouzhouping, 20180301. FreemeAppTheme, statusbar style.
    ...
    private void loadDimens() {
        ...
        //*/ freeme.gouzhouping, 20180808. notch.
        if (NotchUtils.hasNotch()) {
            mStatusBarPaddingEnd = res.getDimensionPixelSize(R.dimen.notch_status_bar_end_padding);
    ...
    protected void onAttachedToWindow() {
        ...
        //*/ freeme.gouzhouping, 20180807. notch.
        if (NotchUtils.hasNotch()) {
            mStatusBarIcons = (LinearLayout) findViewById(R.id.statusIcons);
            mIconManager = new TintedIconManager(mStatusBarIcons);
            mStatusBarIcons.getViewTreeObserver().addOnGlobalLayoutListener(mStatusIconsListener);
        } else
        //*/
    ...
    protected void onDetachedFromWindow() {
        ...
        //*/ freeme.gouzhouping, 20180808. notch.
        if (NotchUtils.hasNotch()) {
            mStatusBarIcons.getViewTreeObserver().removeOnGlobalLayoutListener(mStatusIconsListener);
        }
        //*/
    }
    ...
    //*/ freeme.gouzhouping, 20180807. notch.
    private LinearLayout mStatusBarIcons;
    private ImageView mBatteryBorder;
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mStatusIconsListener =
            new ViewTreeObserver.OnGlobalLayoutListener() {
                @Override
                public void onGlobalLayout() {
                    int width = mStatusBarIcons.getWidth();
                    if (width != mOldWidth) {
                        mOldWidth = width;
                        updateStatusIcons();
                    }
    ...
    private void updateStatusIcons() {
        ...
        int count = 0;
        int showNum = (getShowWidth() - mBatteryBorder.getWidth() - mStatusBarPaddingEnd) / mIconSize;

        for (int i = mStatusBarIcons.getChildCount() - 1; i > 0; i--) {
            iconView = (StatusBarIconView) mStatusBarIcons.getChildAt(i);
    ...
    private int getShowWidth() {
        return (getDisplay().getWidth() - NotchUtils.getNotchWidth()) / 2;
    }
    //*/
}
