...
public class NotificationIconAreaController implements DarkReceiver {
    ...
    private void reloadDimens(Context context) {
        ...
        /*/
        mIconSize = res.getDimensionPixelSize(R.dimen.freeme_status_bar_notification_icon_size);
        mIconHPadding = res.getDimensionPixelSize(R.dimen.freeme_status_bar_icon_horizontal_padding);
        //*/
    }
    ...
    private void updateTintForIcon(StatusBarIconView v) {
        ...
        /*/ freeme.gouzhouping, 20180313. FreemeAppTheme, fix notification icon white
