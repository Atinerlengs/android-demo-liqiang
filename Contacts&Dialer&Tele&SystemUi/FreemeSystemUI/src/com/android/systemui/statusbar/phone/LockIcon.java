...
public class LockIcon extends KeyguardAffordanceView implements OnUserInfoChangedListener {
    ...
    public void updateLockIconVisibility() {
        ...
        final boolean faceprintRunning = monitor.isFaceUnlockRunning(mContext.getUserId())
                || monitor.hasEnrolledFace();
        setVisibility(mLastState == STATE_FACE_UNLOCK
                && (mUnlockMethodCache.isFaceUnlockRunning() || faceprintRunning) ? VISIBLE : GONE);
    }
    //*/
}
