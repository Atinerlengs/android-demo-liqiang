...
public class PhoneStatusBarPolicy implements Callback, Callbacks,
    ...
    /*/ freeme.gouzhouping, 20180310. FreemeAppTheme, status bar icons.
    public static final int LOCATION_STATUS_ICON_ID = R.drawable.stat_sys_location;
    /*/
    public static final int LOCATION_STATUS_ICON_ID = R.drawable.freeme_stat_sys_location;
    //*/
    ...
    public PhoneStatusBarPolicy(Context context, StatusBarIconController iconController) {
        ...
        //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, status bar icons.
        mIconController.setIcon(mSlotVolume, R.drawable.freeme_stat_sys_ringer_vibrate, null);
        //*/
        ...
        //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, status bar icons.
        mIconController.setIcon(mSlotHotspot, R.drawable.freeme_stat_sys_hotspot,
                mContext.getString(R.string.accessibility_status_bar_hotspot));
        //*/
        ...
        /*/
        mIconController.setIcon(mSlotManagedProfile, R.drawable.freeme_stat_sys_managed_profile_status,
                mContext.getString(R.string.accessibility_managed_profile));
        //*/
        ...
        /*/
        mIconController.setIcon(mSlotDataSaver, R.drawable.freeme_stat_sys_data_saver,
                context.getString(R.string.accessibility_data_saver_on));
        //*/
    ...
    private void updateAlarm() {
        ...
        /*/
        mIconController.setIcon(mSlotAlarmClock, zenNone ? R.drawable.freeme_stat_sys_alarm_dim
                : R.drawable.freeme_stat_sys_alarm, null);
        //*/
    ...
    private final void updateVolumeZen() {
        ...
        if (DndTile.isVisible(mContext) && !DndTile.isCombinedIcon(mContext)
            ...
            //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, status bar icons.
            volumeIconId = R.drawable.freeme_stat_sys_ringer_silent;
            //*/
            ...
            //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, status bar icons.
            volumeIconId = R.drawable.freeme_stat_sys_ringer_vibrate;
            //*/
        ...
        if (zenVisible) {
            ...
            if (zen == Global.ZEN_MODE_IMPORTANT_INTERRUPTIONS) {
                zenIconId = R.drawable.freeme_stat_sys_zen_important;
            } else {
                zenIconId = R.drawable.freeme_stat_sys_ringer_silent;
            }
            //*/
    ...
    private final void updateBluetooth() {
        ...
        //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, status bar icons.
        iconId = R.drawable.freeme_stat_sys_data_bluetooth;
        //*/
        ...
        if (mBluetooth != null) {
            ...
            if (mBluetooth.isBluetoothConnected()) {
                ...
                //*/ freeme.gouzhouping, 20180310. FreemeAppTheme, status bar icons.
                iconId = R.drawable.freeme_stat_sys_data_bluetooth_connected;
                //*/
    ...
    private final void updateTTY(int currentTtyMode) {
        ...
        if (enabled) {
            ...
            /*/
            mIconController.setIcon(mSlotTty, R.drawable.freeme_stat_sys_tty_mode,
                    mContext.getString(R.string.accessibility_tty_enabled));
            //*/
    ...
    protected void updateEmbmsState(Intent intent) {
        ...
        if (isActive == 1) {
            ...
            /*/
            mIconController.setIcon(mSlotEmbms, R.drawable.freeme_stat_sys_embms,
                    mContext.getString(R.string.accessibility_embms_enabled));
            //*/
            ...
            try {
                ...
                mHandler.post(() -> {
                    ...
                    if (isManagedProfile &&
                        ...
                        /*/
                        mIconController.setIcon(mSlotManagedProfile,
                                R.drawable.freeme_stat_sys_managed_profile_status,
                                mContext.getString(R.string.accessibility_managed_profile));
                        //*/
    ...
    private void updateHeadsetPlug(Intent intent) {
        ...
        if (connected) {
            ...
            /*/
            mIconController.setIcon(mSlotHeadset, hasMic ? R.drawable.freeme_ic_headset_mic
                    : R.drawable.freeme_ic_headset, contentDescription);
            //*/
