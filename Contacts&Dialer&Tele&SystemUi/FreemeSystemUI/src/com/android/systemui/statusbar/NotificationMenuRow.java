...
public class NotificationMenuRow implements NotificationMenuRowPlugin, View.OnClickListener,
    ...
    public NotificationMenuRow(Context context) {
        ...
        //*/ freeme.biantao, 20180207. Theme.Freeme 8.1 - notification.
        mSnoozeStart = context.getResources().getDimensionPixelOffset(R.dimen.notification_item_snooze_margin_start);
        mSnoozeEnd   = context.getResources().getDimensionPixelOffset(R.dimen.notification_item_snooze_margin_end);
        //*/
    }
    ...
    private void setMenuLocation() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            /*/
            final float left = i * mHorizSpaceForIcon + mSnoozeStart;
            final float right = mParent.getWidth() - (mHorizSpaceForIcon * (i + 1)) - mSnoozeEnd;
            //*/
    ...
    public static MenuItem createSnoozeItem(Context context) {
        ...
        /*/
        MenuItem snooze = new NotificationMenuItem(context, snoozeDescription, content,
                R.drawable.freeme_notification_ic_snooze);
        //*/
        return snooze;
    }
    ...
    public static MenuItem createInfoItem(Context context) {
        ...
        /*/
        MenuItem info = new NotificationMenuItem(context, infoDescription, infoContent,
                R.drawable.freeme_notification_ic_settings);
        //*/
        return info;
    }
