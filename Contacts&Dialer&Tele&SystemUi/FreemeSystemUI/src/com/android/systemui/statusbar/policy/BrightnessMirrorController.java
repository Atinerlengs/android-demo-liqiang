...
public class BrightnessMirrorController
    ...
    public void showMirror() {
        ...
        mBrightnessMirror.setBackgroundColor(mStatusBarWindow.getResources()
                .getColor(R.color.freeme_brightness_mirror_background_color));
        mStatusBarWindow.getService().showMirror();
        //*/
    }
    ...
    public void hideMirror() {
        ...
        mStatusBarWindow.getService().hideMirror();
        //*/
    }
    ...
    public void setLocation(View original) {
        ...
        //*/ freeme.chenming, 20180227. FreemeAppTheme, blur view
        if (mBlur != null) {
            int left = mInt2Cache[0] + ((int) mBrightnessMirror.getTranslationX());
            int top = mInt2Cache[1] + ((int) mBrightnessMirror.getTranslationY());
            mBrightnessMirror.setBackground(new BitmapDrawable(mBrightnessMirror.getResources(),
                    Bitmap.createBitmap(mBlur, left, top, mBrightnessMirror.getWidth(), mBrightnessMirror.getHeight())));
        }
        //*/
    }
    ...
    public void setBlur(Bitmap blur) {
        if (mBlur != null) {
            BitmapDrawable drawable = new BitmapDrawable(mBrightnessMirror.getResources(), blur);
            drawable.setBounds(0, 0,
                    mStatusBarWindow.getService().getScreenWidth(),
                    mStatusBarWindow.getService().getScreenHeight());
            mBlur = drawable.getBitmap();
        }
    }
    //*/
}
