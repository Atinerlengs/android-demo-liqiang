...
public class HeadsUpManager implements ViewTreeObserver.OnComputeInternalInsetsListener,
    ...
    public HeadsUpManager(final Context context, View statusBarWindowView,
        ...
        mHeadsUpSlop = context.getResources().getDimensionPixelSize(R.dimen.notch_heads_up_noti_height);
        //*/
    }
    ...
    public void showNotification(NotificationData.Entry headsUp) {
        ...
        //*/ freeme.zhaozehong, 20180809. GameMode
        if (com.freeme.systemui.utils.GameModeUtils.getInstance(mContext)
                .isBlockedNotification(headsUp.notification)) {
            // the game mode wants to block Heads-up notification
            return;
        }
        //*/
    ...
    public void onComputeInternalInsets(ViewTreeObserver.InternalInsetsInfo info) {
        ...
        if (mHasPinnedNotification) {
            ...
            if (NotchUtils.hasNotch()) {
                notchHeight = NotchUtils.getNotchHeight() + mHeadsUpSlop;
            }
            info.touchableRegion.set(minX, 0, maxX, maxY + notchHeight);
            //*/
