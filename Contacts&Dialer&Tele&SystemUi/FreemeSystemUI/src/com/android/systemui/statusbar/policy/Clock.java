...
public class Clock extends TextView implements DemoMode, Tunable, CommandQueue.Callbacks,
    ...
    private final CharSequence getSmallTime() {
        ...
        /*/
        if (!format.equals(mClockFormatString) || NotchUtils.hasNotch()) {
        //*/
    ...
    public void setShowOriginalAmPm(boolean isShow) {
        mIsShow = isShow;
    }
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        if (NotchUtils.hasNotch() && mIsShow) {
            mAmPmStyle = (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE)
                    ? AM_PM_STYLE_NORMAL : AM_PM_STYLE_GONE;
            updateClock();
        }
    }
    //*/
