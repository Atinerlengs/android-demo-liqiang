...
public class NotificationShelf extends ActivatableNotificationView implements
    ...
    private void updateIconPositioning(ExpandableNotificationRow row, float iconTransitionAmount,
        ...
        if (isLastChild || !USE_ANIMATIONS_WHEN_OPENING || iconState.useFullTransitionAmount
            ...
            /*/
            transitionAmount = iconTransitionAmount > 0.5f ? 1.0f : 0.0f;
            //*/
        } else {
    ...
    //*/ freeme.xiaohui,20180509, Bug:34262
    @Override
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Resources res = getResources();
        int mMarginLeft = res.getDimensionPixelOffset(R.dimen.notification_item_margin_start);
        int mMarginRight = res.getDimensionPixelOffset(R.dimen.notification_item_margin_end);
        int widthMeasureSpecNew = MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec) - mMarginLeft - mMarginRight
