...
public class KeyguardViewMediator extends SystemUI {
    ...
    ViewMediatorCallback mViewMediatorCallback = new ViewMediatorCallback() {
        ...
        public int getBouncerPromptReason() {
            ...
            any |= mUpdateMonitor.hasEnrolledFace();
            //*/
    ...
    public void onStartedWakingUp() {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime onStartedWakingUp: " + (java.lang.System.currentTimeMillis() - beginTime));
        }
        //*/
    }
    ...
    public void onScreenTurningOn(IKeyguardDrawnCallback callback) {
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime onStartedWakingUp: " + java.lang.System.currentTimeMillis());
        }
        //*/
    ...
    private void maybeSendUserPresentBroadcast() {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime maybeSendUserPresentBroadcast: " + (java.lang.System.currentTimeMillis() - beginTime));
        }
        //*/
    }
    ...
    private void handleKeyguardDone() {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime handleKeyguardDone: " + (java.lang.System.currentTimeMillis() - beginTime));
    ...
    private void handleHide() {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime handleHide: " + (java.lang.System.currentTimeMillis() - beginTime));
        }
        //*/
    }
    ...
    private void handleStartKeyguardExitAnimation(long startTime, long fadeoutDuration) {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime handleStartKeyguardExitAnimation: " + (java.lang.System.currentTimeMillis() - beginTime));
        }
        //*/
    }
                ...
                if (mWakeAndUnlocking) {
                    ...
                    if (TimeWasteLog.DEBUG_TIME_WASTE) {
                        Log.d(TimeWasteLog.FP_LOG_TAG, "handleNotifyScreenTurningOn pending DrawnCallback" +
                                "\": " + (java.lang.System.currentTimeMillis() - beginTime));
                    }
                    //*/
                } else {
    ...
    private void handleNotifyScreenTurnedOn() {
        ...
        //*/ freeme.chenming, 20171127. Fp Wake
        if (TimeWasteLog.DEBUG_TIME_WASTE) {
            Log.d(TimeWasteLog.FP_LOG_TAG, "wasteTime handleNotifyScreenTurnedOn: " + (java.lang.System.currentTimeMillis() - beginTime));
        }
        //*/
    }
