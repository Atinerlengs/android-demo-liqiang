...
public class ToggleSliderView extends RelativeLayout implements ToggleSlider {
    ...
    //*/ freeme.gouzhouping, 20180503. FeemeAppTheme, qs container.
    private final boolean mSupportAuto;
    //*/
    ...
    public ToggleSliderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*/ freeme.gouzhouping, 20180118. FeemeAppTheme, qs container.
        View.inflate(context, R.layout.status_bar_toggle_slider, this);
        /*/
        mSupportAuto = context.getResources().getBoolean(com.android.internal.R.bool.config_automatic_brightness_available);
        View.inflate(context, mSupportAuto ? R.layout.freeme_status_bar_toggle_slider
                : R.layout.freeme_status_bar_toggle_slider_unsupport_auto, this);
        //*/
