...
public class SimProcessorService extends Service {
    ...
    public void onCreate() {
        ...
        /*/ freeme.zhaozehong, 20180328. for freemeOS, UI redesign
        Notification.Builder builder = new Notification.Builder(this)
                .setWhen(System.currentTimeMillis())
                .setSmallIcon(android.R.drawable.ic_dialog_alert)
                .setTicker(ONGOING_NOTIFICATION);
        /*/
        String content = getString(R.string.freeme_sim_processor_notification_msg);
        Notification.Builder builder = new Notification.Builder(this)
                .setWhen(System.currentTimeMillis())
                .setTicker(content)
                .setSmallIcon(R.drawable.freeme_sim_processor_notification_icon)
    ...
    public int onStartCommand(Intent intent, int flags, int id) {
        ...
        //*/ freeme.zhaozehong, 20180711. fix can't read contacts in usim card
    ...
    public void onDestroy() {
        ...
        Log.i(TAG, "[onDestroy]...");
        stopForeground(true);
        //ensure com.mediatek.SimProcessor killed in low memory project.
        if (SimProcessorUtils.MTK_LOW_RAM_CONFIG) {
            Log.i(TAG, "[onDestroy]System.exit(0)");
            System.exit(0);
        }
    }
