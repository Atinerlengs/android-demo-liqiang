...
public class SimProcessorUtils {
    ...
    public static final boolean MTK_LOW_RAM_CONFIG = isPropertyTrue("ro.config.low_ram");
    ...
    private static boolean isPropertyTrue(String propertyString) {
        return "true".equals(SystemProperties.get(propertyString));
    }
