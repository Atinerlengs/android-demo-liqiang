...
public class ExportVCardActivity extends Activity implements ServiceConnection,
    ...
    protected void onCreate(Bundle bundle) {
        ...
        /// M:[MTK IMPORT/EXPORT] Check directory is available.@{
    ...
    /**
     * M: [MTK IMPORT/EXPORT]Returns the name of the target path with additional
     * formatting characters to improve its appearance in bidirectional text. @{
     */
    ...
    protected Dialog onCreateDialog(int id, Bundle bundle) {
        if (id == R.id.dialog_fail_to_export_with_reason) {
            Log.w(LOG_TAG, "[onCreateDialog] lry 1");
        ...
        /// M: [MTK IMPORT/EXPORT] @{
            ...
            Log.w(LOG_TAG, "[onCreateDialog] lry 2");
            return new AlertDialog.Builder(this)
            ...
            Log.w(LOG_TAG, "[onCreateDialog] lry 3");
            mProcessOngoing = false;
            return new AlertDialog.Builder(this)
