...
public abstract class MultiSelectContactsListFragment<T extends MultiSelectEntryContactListAdapter>
    ...
    protected boolean onItemLongClick(int position, long id) {
        ...
        /*/freeme.zhangjunjian, 20180224. redesign contact editors
        if (mCheckBoxListListener != null
        ...
        //*/
        //*/freeme.zhangjunjian, 20180224. redesign contact editors
        if (mSelectCountCallBack != null) {
            mSelectCountCallBack.onShowCount(getAdapter().getSelectedContactIds().size());
        }
        //*/
        return true;
    }
    ...
    public void updateSelectedItemsView() {
        ...
        Log.d(TAG, "[updateSelectedItemsView]count:" + count +
                ...
                ", favorite:" + getAdapter().getNumberOfFavorites() +
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        //*/ freeme.zhaozehong, 20180411.
        // does not verify that the selected contact exists in the search mode
    ...
    //*/freeme.zhangjunjian, 20180224. redesign contact editors
    private ISelectCountCallBack mSelectCountCallBack;

    public void setContactsCountCallBack(ISelectCountCallBack callBack) {
        this.mSelectCountCallBack = callBack;
    }
