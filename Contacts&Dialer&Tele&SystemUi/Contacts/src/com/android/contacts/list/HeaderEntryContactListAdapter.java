...
public class HeaderEntryContactListAdapter extends DefaultContactListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (position == 0 && getHeaderEntryCount() > 0) {
            ...
            //*/ freeme.liqiang, 20180314. add line under headerview
            itemView.getNameTextView().setTextColor(getContext().getColor(R.color.freeme_quick_contact_textcolor));
            itemView.getBottomeLine();
            //*/
            return itemView;
        }
