...
public class MultiSelectPhoneNumbersListFragment
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        //*/ freeme.linqingwei, 20180327. redesign multi selection for 8.1 style.
        item.setVisible(getAdapter().getCount() > 0);
        item.setEnabled(getAdapter().hasSelectedItems());
        // fix JE, in case of getActionView return null.
        /*/
