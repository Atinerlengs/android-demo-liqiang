...
public class GroupMembersAdapter extends MultiSelectEntryContactListAdapter {
    ...
    protected ContactListItemView newView(Context context, int partition, Cursor cursor,
        ...
        int pading = mContext.getResources().getDimensionPixelSize(R.dimen.freeme_group_member_list_item_padding);
        int rightPading = pading - view.FREEME_GAP_SCROLL_BAR_DEFAULT;
        view.setPadding(pading, 0, rightPading, 0);
        view.setAdjustSelectionBoundsEnabled(false);
        view.getContactDetailView().setImageResource(R.drawable.freeme_contacts_detail_icon);
        view.setBackgroundResource(R.drawable.freeme_list_item_press_selector);
        //*/
    ...
    protected void bindView(View v, int partition, Cursor cursor, int position) {
        ...
        /*/freeme.zhangjunjian, 20180224. redesign group edit
        bindSectionHeaderAndDivider(view, position);
        //*/
        bindName(view, cursor);
        //*/freeme.zhangjunjian, 20180224. redesign group edit
        bindCheckBox(view, cursor, partition == ContactsContract.Directory.DEFAULT);
        view.getContactDetailView().setVisibility(isDisplayingCheckBoxes() ? View.GONE : View.VISIBLE);
        //*/
        /*/freeme.zhangjunjian, 20180224. redesign group edit
