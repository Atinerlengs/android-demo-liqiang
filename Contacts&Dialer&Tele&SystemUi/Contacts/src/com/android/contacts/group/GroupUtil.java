...
public final class GroupUtil {
    ...
    //*/ freeme.zhaozehong, 20180320. for freemeOS, UI redesign
    public final static String PHONE_SELECTION =
            Groups.ACCOUNT_TYPE + " = " + "\"" + AccountTypeUtils.ACCOUNT_TYPE_LOCAL_PHONE + "\"" +
    ...
    public static Intent createPickMemberIntent(Context context, GroupMetaData groupMetaData,
                                                ArrayList<String> memberContactIds, int subId,
                                                boolean showSelectMode) {
        Intent intent = createPickMemberIntent(context, groupMetaData, memberContactIds, subId);
        intent.putExtra(SHOW_SELECT_MODE, showSelectMode);
        return intent;
    }
    //*/
}
