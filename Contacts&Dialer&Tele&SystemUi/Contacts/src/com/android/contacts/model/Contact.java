...
public class Contact {
    ...
    //*/ freeme.zhaozehong, 17-1-6. save phoneNumber list
    private static ArrayList<String> numberArrayLists = new ArrayList<String>();

    public static void setPhoneNumberLists(ArrayList<String> numArrayList) {
        numberArrayLists = numArrayList;
    }

    public ArrayList<String> getPhoneNumberLists() {
        return numberArrayLists;
    }
    //*/
}
