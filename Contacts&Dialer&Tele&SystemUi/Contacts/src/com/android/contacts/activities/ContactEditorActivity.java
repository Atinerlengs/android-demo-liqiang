...
public class ContactEditorActivity extends AppCompatContactsActivity implements
    ...
    //*/ freeme.liqiang, 20180329. remove stranger interface when save contacts
            ...
            new ContactEditorFragment.Listener() {
                ...
                public void onSaveFinished(Intent resultIntent) {
                    if (mFinishActivityOnSaveCompleted) {
                        ...
                        //*/ freeme.liqiang, 20180329. remove stranger interface when save contacts
                        resultIntent.putExtra(SAVE, true);
    ...
    public void onCreate(Bundle savedState) {
        ...
        if (bar != null) {
            ...
            FreemeActionBarUtil.setBackTitle(bar, getResources().getString(R.string.freeme_contact_item_cancle));
        }
        if (Intent.ACTION_EDIT.equals(action)) {
            mActionBarTitleResId = R.string.contact_editor_title_existing_contact;
        } else {
        ...
        String title = getIntent().getStringExtra(FreemeIntentUtils.KEY_ACTIVITY_TITLE);
