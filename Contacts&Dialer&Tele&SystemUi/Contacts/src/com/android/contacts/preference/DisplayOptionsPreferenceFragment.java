...
public class DisplayOptionsPreferenceFragment extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ///M: [Op01 plugin] @{
        if (RequestPermissionsActivity.hasRequiredPermissions(getContext())) {
            ExtensionManager.getInstance().getOp01Extension().addOptionsMenu(getContext(), this);
        } else {
            Log.e("OptionsPreferenceFragment", "ignore OP01 addOptionsMenu() due to permissio");
        }
        /// @}
    }
    ...
    public boolean onPreferenceClick(Preference p) {
        ...
        if (KEY_ABOUT.equals(prefKey)) {
             ...
             * @{ */
            ActivitiesUtils.doExport(getContext());
            /* @} */
            return true;
