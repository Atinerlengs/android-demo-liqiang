...
//*/ freeme.zhaozehong, 20180814. for freemeOS, UI redesign
...
public class ContactsPreferences implements OnSharedPreferenceChangeListener {
    ...
    ContactsPreferences(Context context, boolean isDefaultAccountUserChangeable) {
        ...
        final AccountWithDataSet accountWithDataSet = new AccountWithDataSet(
                AccountTypeUtils.ACCOUNT_NAME_LOCAL_PHONE,
                AccountTypeUtils.ACCOUNT_TYPE_LOCAL_PHONE,
                null);
        mDefaultAccount = accountWithDataSet;
        mDefaultAccountStringify = accountWithDataSet.stringify();
        //*/
    ...
    public AccountWithDataSet getDefaultAccount() {
        ...
        if (mDefaultAccount == null) {
            ...
            /*/
            final String accountString = mPreferences
                    .getString(mDefaultAccountKey, mDefaultAccountStringify);
            //*/
    ...
    private void maybeMigrateSystemSettings() {
        ...
        if (!mPreferences.contains(mDefaultAccountKey)) {
            ...
            /*/
            final String defaultAccount = previousPrefs.getString(mDefaultAccountKey,
                    mDefaultAccountStringify);
            //*/
    ...
    //*/ freeme.zhaozehong, 20180814. for set default account to save contacts
    private final String mDefaultAccountStringify;
    //*/
}
