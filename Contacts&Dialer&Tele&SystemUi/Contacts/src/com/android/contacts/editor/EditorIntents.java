...
public class EditorIntents {
    ...
    private static final String PHONE_OR_EMAIL_ENTRY_CARD = "phone_or_email_entry_card";

    public static Intent createEditContactIntent(Context context, Uri uri, MaterialPalette materialPalette,
                                                 long photoId, String title, String mCustomRingtone) {
        return createEditContactIntent(context, uri, materialPalette, photoId,
                title, mCustomRingtone, null);
    }

    public static Intent createEditContactIntent(Context context, Uri uri, MaterialPalette materialPalette,
                                                 long photoId, String title, String mCustomRingtone, String entryType) {

        final Intent intent = createEditContactIntent(context, uri, materialPalette, photoId);
        intent.putExtra(KEY_ACTIVITY_TITLE, title);
        intent.putExtra(PHONE_OR_EMAIL_ENTRY_CARD, entryType);
        intent.putExtra(ContactEditorFragment.INTENT_EXTRA_RING_CONTACT, mCustomRingtone);
        return intent;
    }
    //*/
}
