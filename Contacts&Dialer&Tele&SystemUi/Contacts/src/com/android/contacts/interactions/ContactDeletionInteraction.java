...
//*/ freeme.zhaozehong, 20180814. disable contact shortcut when contact was deleted
...
public class ContactDeletionInteraction extends BaseEventHandlerFragment
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (readOnlyCount > 0 && writableCount > 0) {
            ...
            /*/
            mMessageId = mIsUserProfile ? R.string.freeme_delete_user_profile_Confirmation : R.string.deleteConfirmation;
            //*/
            positiveButtonId = R.string.deleteConfirmation_positive_button;
        }
    ...
    protected void doDeleteContact(Uri contactUri) {
        ...
        //*/ freeme.liqiang, 20180810. disable contact shortcut when contact was deleted
        disableShortcuts();
        //*/
    ...
    public static void setIsUserProfile(boolean isUserProfile){
    ...
    private void disableShortcuts() {
        if (!TextUtils.isEmpty(mLookupKey)
            ...
            lookupKeys.add(mLookupKey);

            Intent intent = new Intent(mContext, FreemeDisableShortcutService.class);
