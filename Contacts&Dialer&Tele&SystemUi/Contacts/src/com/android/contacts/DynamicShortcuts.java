...
public class DynamicShortcuts {
    ...
    private Bitmap getFallbackAvatar(String displayName, String lookupKey) {
        ...
        /*/
        final ContactPhotoManager.DefaultImageRequest request =
                new ContactPhotoManager.DefaultImageRequest(displayName, lookupKey, ContactPhotoManager.TYPE_SHORTCUT,
                        ContactPhotoManager.SCALE_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, circularIcon);
        //*/
        if (BuildCompat.isAtLeastO()) {
