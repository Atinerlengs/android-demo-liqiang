...
public abstract class PhotoSelectionHandler implements OnClickListener {
    ...
    private Intent getTakePhotoIntent(Uri outputUri) {
        ...
        //*/freeme.zhangjunhe,20180905 set default freeme camera  in editting contacts photo interface
        intent.setPackage(CAMERA_PACKAGE);
        //*/
    ...
    //*/freeme.zhangjunhe,20180905 set default freeme camera in editting contacts photo interface
    private static final String CAMERA_PACKAGE = "com.freeme.camera";
    //*/
}
