...
public class SimImportFragment extends Fragment
    ...
    private void updateToolbarWithCurrentSelections() {
        ...
        /*/
        mImportableCount = importableCount;
        if (importableCount == 0) {
            getActivity().setTitle(R.string.sim_import_title_none_selected);
        } else {
            getActivity().setTitle(String.valueOf(importableCount));
        }
        //*/
    }
    ...
    private static final int MEMU_ID_IMPORT = 0x100;
    private int mImportableCount;

    @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        super.onCreateOptionsMenu(menu, inflater);
        menu.add(0, MEMU_ID_IMPORT, 0, R.string.sim_import_button_text)
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(MEMU_ID_IMPORT).setVisible(mImportableCount > 0);
    }
