...
public class DrawerAdapter extends BaseAdapter {
    ...
    private boolean isVoLTEConfCallEnable(Context context) {
        ...
        for (PhoneAccount phoneAccount : phoneAccounts) {
            ...
            if (!MtkTelephonyManagerEx.getDefault().isVolteEnabled(subId)) {
                continue;
            }
    ...
    public void notifyCarrierConfChanged() {
        boolean enabled = isVoLTEConfCallEnable(mActivity);
        Log.e(TAG, "[notifyCarrierConfChanged]old = " + mIsVolteConfCallEnabled +
                ", enabled = " + enabled);
