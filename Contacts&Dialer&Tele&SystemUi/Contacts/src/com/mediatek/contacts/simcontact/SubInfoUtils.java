...
public class SubInfoUtils {
    ...
    public static Bitmap getIconBitmap(int subId) {
        ...
        Context context = GlobalEnv.getApplicationContext();
        return info == null ? null : info.createIconBitmap(GlobalEnv.getApplicationContext(),
                context.getColor(R.color.freeme_quick_contact_sub_title_color),
                ContactsSystemProperties.MTK_GEMINI_SUPPORT);
        /*/
