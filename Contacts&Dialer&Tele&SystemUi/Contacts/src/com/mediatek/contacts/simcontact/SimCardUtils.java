    ...
    public static class ShowSimCardStorageInfoTask extends AsyncTask<Void, Void, Void> {
        ...
        public static void showSimCardStorageInfo(Context context,
            ...
            sInstance = new ShowSimCardStorageInfoTask(context,
                    needToastIfFull, subIdToShow);
            sInstance.execute();
            Log.i(TAG, "[showSimCardStorageInfo] needPopUp = " + needToastIfFull
            ...
            if (!mIsCancelled && (subscriptionInfoList != null)
                ...
                for (SubscriptionInfo subscriptionInfo : subscriptionInfoList) {
                    ...
                    Log.i(TAG, "[ShowSimCardStorageInfoTask]"
                            + ", subId:" + subscriptionInfo.getSubscriptionId()
                            + ": storage:" + (storageInfos == null ? "NULL" : storageInfos[1])
                            + ", used:" + (storageInfos == null ? "NULL" : storageInfos[0]));
