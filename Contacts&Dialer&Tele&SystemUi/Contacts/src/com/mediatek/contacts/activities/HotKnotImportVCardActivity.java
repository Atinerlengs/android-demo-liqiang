...
import com.android.contacts.vcard.VCardImportExportListener;
...
public class HotKnotImportVCardActivity extends Activity implements
    ...
    @Override
    public Notification onImportParsed(ImportRequest request, int jobId,
                                     VCardEntry entry, int currentCount,
            int totalCount) {
        return null;
    }
