...
public class SimGroupProcessor extends SimProcessorBase {
    ...
    public void doWork() {
        ...
        else if (ContactSaveService.ACTION_DELETE_MULTIPLE_GROUPS.equals(action)) {
            deleteMultipleGroups(mIntent);
        }
        //*/
    }
    ...
    private void renameGroup(Intent intent) {
        ...
        Log.d(TAG, "[renameGroup]update to db, group uri = " + groupUri
                + ", values = " + values);
    ...
    private void updateGroup(Intent intent) {
        ...
        Log.i(TAG, "[updateGroup]isAddSuccess:" + isAddSuccess +
                ", isRemoveSuccess:" + isRemoveSuccess + ", groupUri:" + groupUri);
        callbackIntent.setData(groupUri);
        deliverCallback(callbackIntent);
    }
