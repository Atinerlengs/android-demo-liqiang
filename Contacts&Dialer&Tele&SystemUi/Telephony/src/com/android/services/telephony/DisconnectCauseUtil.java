    ...
    */
        ...
        switch (telephonyDisconnectCause) {
            ...
            default:
                Log.w("DisconnectCauseUtil.toTelecomDisconnectCauseCode",
                        ...
                        + telephonyDisconnectCause);
                return ExtensionManager.getDisconnectCauseExt().toTelecomDisconnectCauseCode(
                        telephonyDisconnectCause, DisconnectCause.UNKNOWN);
        }
    }
    ...
    private static CharSequence toTelecomDisconnectCauseLabel(
        ...
        return resourceId == null ? ExtensionManager.getDisconnectCauseExt().
                toTelecomDisconnectCauseLabel(telephonyDisconnectCause) :
    ...
    protected static CharSequence toTelecomDisconnectCauseDescription(
        ...
        return resourceId == null ? ExtensionManager.getDisconnectCauseExt().
                toTelecomDisconnectCauseDescription(telephonyDisconnectCause) :
                context.getResources().getString(resourceId);
    }
