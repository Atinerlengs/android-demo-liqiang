...
public final class PstnIncomingCallNotifier {
    ...
    /**
     * M: For [Digits] extension, the plugin need call this constructor. change it public.
     ...
     *
     * @param phone The phone object for listening to incoming calls.
     * @param phoneAccountHandle listening to incoming calls of this phoneAccountHandle.
     */
    ...
    private void handleCdmaCallWaiting(AsyncResult asyncResult) {
        ...
        if (call.getState() == Call.State.WAITING) {
            ...
            if (connection != null) {
                ...
                /// M: Handle waiting call with restricted or unknown number. @{
    ...
    private void sendIncomingCallIntent(Connection connection) {
        ...
        //For RTT feature
        ExtensionManager.getRttUtilExt().setIncomingRttCall(connection, extras);
    ...
    private PhoneAccountHandle findCorrectPhoneAccountHandle() {
        ...
        /// M: for digits@{
        handle = ExtensionManager.getDigitsUtilExt().getCorrectPhoneAccountHandle(handle,
                mPhoneAccountHandle, mPhone.getContext());
        /// @}
