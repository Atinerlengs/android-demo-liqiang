...
//*/ freeme.liqiang, 20180414. redesign emergency UI
...
public class EmergencyDialer extends Activity implements View.OnClickListener,
    ...
    private static final int[] DIALER_KEYS = new int[] {
            ...
            /*/ freeme.liqiang, 20180413. redesign emergency UI
            R.id.star, R.id.zero, R.id.pound };
            /*/
            R.id.star, R.id.zero, R.id.pound,
            R.id.cancel, R.id.dial, R.id.deleteNumer};
            //*/
    ...
    /*/ freeme.liqiang, 20180413. redesign emergency UI 60% opactity
    private static final int BACKGROUND_GRADIENT_ALPHA = 230;
    /*/
    private static final int BACKGROUND_GRADIENT_ALPHA = 153;
    //*/
    ...
    private boolean sIsSupportSubsidyLock;
    ///@}
    EditText mDigits;
    /*/ freeme.liqiang, 20180413. redesign emergency UI
    ...
    public void afterTextChanged(Editable input) {
        ///M: Subsidy lock feature for OP18 @{
        if (sIsSupportSubsidyLock && "*#5625".equals(input.toString())) {
            Intent intent = new Intent(MTK_SECRET_CODE_INTENT);
            Log.d(LOG_TAG, "send SECRET CODE ACTION broadcast with *#5625");
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //*/freeme.zhangjunhe 20180905.hide recent key
        View decorView = getWindow().getDecorView();
        decorView.setSystemUiVisibility(decorView.getSystemUiVisibility() | View.STATUS_BAR_DISABLE_RECENT);
        //*/
        ...
        /*/ freeme.liqiang, 20180412. redesign emergency UI
        setContentView(R.layout.emergency_dialer);
        /*/
        setContentView(R.layout.freeme_emergency_dialer);
        //*/
        ...
        //*/ freeme.liqiang, 20180413. redesign emergency UI
        SpannableString spannableString = new SpannableString(getResources().getString(R.string.freeme_dial_emergency_hint));
        AbsoluteSizeSpan absoluteSizeSpan = new AbsoluteSizeSpan(EMERGENCY_HINT_TEXT_SIZE, true);
        spannableString.setSpan(absoluteSizeSpan, 0, spannableString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        mDigits.setHint(new SpannedString(spannableString));
        //*/
    ...
    private void setupKeypad() {
        ...
        //*/ freeme.liqiang, 20180413. redesign emergency UI
        mDelete = findViewById(R.id.deleteNumer);
        mDelete.setOnLongClickListener(this);
        //*/
    }
    ...
    protected void onResume() {
       ...
       sIsSupportSubsidyLock = subsidyLockProp && subsidyLockStatus;
       Log.d(LOG_TAG, "Subsidy Lock Property :" + subsidyLockProp
                        + " subsidy Lock Status :" + subsidyLockStatus);
       if (sIsSupportSubsidyLock) {
            int flags = StatusBarManager.DISABLE_RECENT
    ...
    //*/ freeme.liqiang, 20180414. redesign emergency UI
    private static final int EMERGENCY_HINT_TEXT_SIZE = 28;
    //*/
}
