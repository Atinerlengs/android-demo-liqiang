...
public class CLIRListPreference extends ListPreference {
    ...
    public static boolean needToEnableClirSetting(Context context, int subId) {
        ...
        if (b != null) {
            enableClirSetting = b.getBoolean(MtkCarrierConfigManager
                                            .MTK_KEY_SHOW_CLIR_SETTING_BOOL);
        }
    ...
    /* package */ void init(
        ...
        /// M: for plug-in, to escape CLIR initialization @{
    ...
    private class MyHandler extends Handler {
        ...
        private void handleSetCLIRResponse(Message msg) {
            ...
            if (ar.exception != null) {
                if (DBG) Log.d(LOG_TAG, "handleSetCLIRResponse: ar.exception=" +
                                          ar.exception);
                //setEnabled(false);
            }
            if (DBG) Log.d(LOG_TAG, "handleSetCLIRResponse: re get");
