            ...
            mButtonAPNExpand.setOnPreferenceClickListener(
                    new Preference.OnPreferenceClickListener() {
                        ...
                        public boolean onPreferenceClick(Preference preference) {
                            ...
                            //*/ freeme.zhaozehong, 20180328. add back title
                            intent.putExtra(FreemeActionBarUtil.EXTRA_NAVIGATE_UP_TITLE_TEXT,
                                    mPrefActivity.getString(R.string.freeme_mobile_networks));
                            //*/
            ...
            mButtonOperatorSelectionExpand.setOnPreferenceClickListener(
                    new Preference.OnPreferenceClickListener() {
                        ...
                        public boolean onPreferenceClick(Preference preference) {
                            ...
                            //*/ freeme.liqiang, 20180328. add back title
                            intent.putExtra(FreemeActionBarUtil.EXTRA_NAVIGATE_UP_TITLE_TEXT,
                                    mPrefActivity.getResources().getString(R.string.freeme_mobile_networks));
                            //*/
                            mPrefActivity.startActivity(intent);
                            return true;
                        }
