...
public class PhoneAccountSettingsFragment extends PreferenceFragment
    ...
    private static final String LOG_TAG = "PhoneAccountSettingsFragment";
    ...
    public void onResume() {
        ...
        //*/ freeme.liqiang, 20180321. remove select account item
        mAccountList.removePreference(mDefaultOutgoingAccount);
        //*/
        /// M: Add for plug-in @{
        if (isPrimaryUser()) {
    ...
    private boolean isPrimaryUser() {
        ...
        boolean isPrimaryUser = userManager.isPrimaryUser();
        Log.d(TAG, "isPrimaryUser:" + isPrimaryUser);
