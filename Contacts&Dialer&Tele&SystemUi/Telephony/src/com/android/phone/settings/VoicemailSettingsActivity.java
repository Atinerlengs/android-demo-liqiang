...
//*/ freeme.liqiang, 20180321. modify back title in dialer settings
...
public class VoicemailSettingsActivity extends PreferenceActivity
    ...
    /// M: Print dbg log in eng or userdebug load @{
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //*/ freeme.liqiang, 20180321. add acitonbar and back title
        ...
        mSubscriptionInfoHelper = new SubscriptionInfoHelper(this, getSubIntent());
    ...
    protected void onResume() {
        ...
        if (mShowVoicemailPreference) {
            ...
            if (mVoicemailProviders.hasMoreThanOneVoicemailProvider()) {
                ...
                onPreferenceChange(mVoicemailProviders,
    ...
    private void updateVoiceNumberField() {
        ...
        /// M: Print voiceNumber @{
        if (DBG) log("updateVoiceNumberField(), mOldVmNumber = " + mOldVmNumber);
        /// }@
    ...
    private Intent getSubIntent() {
        Intent subIntent = new Intent();
        subIntent.putExtra(SubscriptionInfoHelper.SUB_ID_EXTRA, -1);
        PhoneAccountHandle phoneHandle =
            getIntent().getParcelableExtra(TelephonyManager.EXTRA_VOICEMAIL_NUMBER);
        if (phoneHandle == null) {
            return subIntent;
        }

        String iccId = phoneHandle.getId();

        log("getSubIntent, iccId:" + iccId);
        ...
        for (Phone phone : PhoneFactory.getPhones()) {
            ...
            log("iccId: " + iccId + " compare to: " + phoneIccId);
            if ((phoneIccId == null) || phoneIccId.isEmpty()) {
                continue;
            }

            if (iccId.equals(phoneIccId)) {
                subIntent.putExtra(SubscriptionInfoHelper.SUB_ID_EXTRA, phone.getSubId());
                return subIntent;
            }
        }
