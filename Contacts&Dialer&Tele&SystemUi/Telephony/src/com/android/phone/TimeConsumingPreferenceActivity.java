...
public class TimeConsumingPreferenceActivity extends PreferenceActivity
    ...
    /// M: add for OEM_ERROR_1
    public static final int OEM_ERROR_1 = 20000;
    private String mOEMDialogMsg = null;
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        if (id == RESPONSE_ERROR || id == RADIO_OFF_ERROR || id == EXCEPTION_ERROR
                ...
                || id == PASSWORD_ERROR || id == OEM_ERROR_1) {
            ...
            ///M: For OEM_ERROR message @{
            if(id == OEM_ERROR_1) {
                builder.setMessage(mOEMDialogMsg);
            }
            /// @}
    ...
    public void onException(Preference preference, CommandException exception) {
        ...
        /// @}
        } else if (exception.getCommandError() == CommandException.Error.OEM_ERROR_1) {
            if (exception.getMessage().startsWith(CommandException.Error.OEM_ERROR_1.toString())
                    == false) {
                mOEMDialogMsg = exception.getMessage();
                onError(preference, OEM_ERROR_1);
            } else {
                preference.setEnabled(false);
