    ...
    public static class GuardSettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mDomesticButtonVoiceRoamGuard =
                    (RoamingSwitchPreference) prefSet.findPreference(DOMESTIC_VOICE_ROAMING_GUARD);
            mDomesticButtonVoiceRoamGuard.setOnPreferenceChangeListener(mRoamingGuardListener);
            mDomesticButtonDataRoamGuard =
                    (RoamingSwitchPreference) prefSet.findPreference(DOMESTIC_DATA_ROAMING_GUARD);
            ...
            /*mInternationalTextRoamGuard =
                    (RoamingSwitchPreference) prefSet.findPreference(
                    INTERNATIONAL_TEXT_ROAMING_GUARD);
            mInternationalTextRoamGuard.setOnPreferenceChangeListener(mRoamingGuardListener);*/
        }
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if (TelephonyManager.getDefault().getSimCount() == 1) {
                        ...
                        phone = PhoneFactory.getPhone(
                                SubscriptionManager.getPhoneId(sSubId));
                        Log.d(TAG, "update for subId " + sSubId +
                                "and update roaming value");
                    }
                    switch (prefKey) {
                        ...
                        case INTERNATIONAL_DATA_ROAMING_GUARD:
                            ...
                            RoamingSettingsReceiver.notifyRoamingSettingsChanged(prefKey);
                            return true;
                        /*case INTERNATIONAL_TEXT_ROAMING_GUARD:
                            Log.d(TAG, "pref: " + prefKey + "new value: " + newValue);
                            android.provider.Settings.Global.putInt(
                                    phone.getContext().getContentResolver(),
                                    Settings.Global.INTERNATIONAL_TEXT_ROAMING_GUARD + sSubId,
                                    val);
                            return true;*/
                        default:
                            return false;
