...
public class RoamingSettingsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(TelephonyIntents.ACTION_SIM_STATE_CHANGED)) {
            ...
            if (subId != SubscriptionManager.INVALID_SUBSCRIPTION_ID &&
                ...
                Phone configPhone;
                try {
                    configPhone = PhoneFactory.getPhone(SubscriptionManager.getPhoneId(subId));
                } catch (Exception e) {
                    Log.d(TAG, "Null phone No need to update value");
                    return;
                }
                CarrierConfigManager configMgr = (CarrierConfigManager) configPhone.getContext().
        ...
        //} else if (action.equalsIgnoreCase(PRECISE_DATA_CONNECTION_ACTION)) {
            ...
            context.getApplicationContext().registerReceiver(this, new IntentFilter(ANY_DATA_STATE_ACTION));
        }
    }
    ...
    private boolean checkCarrierConfig() {
        ...
        if (!configManager.getConfig().
                getBoolean(MtkCarrierConfigManager.
                MTK_KEY_ROAMING_BAR_GUARD_BOOL)) {
    ...
    public void setRoamingEnabled(int subId) {
        ...
        try {
            ...
            int roamingSettingsArray[] = {phoneId, 1, 1, 1, 0, 0};
