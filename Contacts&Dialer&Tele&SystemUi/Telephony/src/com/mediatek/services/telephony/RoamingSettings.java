...
public class RoamingSettings extends PreferenceActivity {
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        private ArrayList<Integer> mRoamingSettingsList;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mDomesticButtonVoiceRoam = (RoamingSwitchPreference) prefSet.findPreference(
                    DOMESTIC_VOICE_TEXT_ROAMING_SETTINGS);
            mDomesticButtonVoiceRoam.setOnPreferenceChangeListener(mRoamingSettingsListener);
            mDomesticButtonDataRoam = (RoamingSwitchPreference) prefSet.findPreference(
            ...
            mInternationalButtonVoiceRoam =
                    (RoamingSwitchPreference) prefSet.findPreference(
                    INTERNATIONAL_VOICE_TEXT_ROAMING_SETTINGS);
            ...
            new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if (TelephonyManager.getDefault().getSimCount() == 1) {
                        ...
                        phone = PhoneFactory.getPhone(SubscriptionManager.getPhoneId(sSubId));
                        Log.d(TAG, "update for subId " + sSubId + "and update roaming value");
                    }
                    int phoneId = SubscriptionManager.getPhoneId(sSubId);
                    ...
                    gsmCdmaphone.setRoamingEnable(responseArray, mHandler.obtainMessage(
                            MyHandler.MESSAGE_SET_ROAMING_SETTINGS));
        ...
        private void initRoamingSettings(int subId) {
            ...
            /*phone.getRoamingEnable(mHandler.obtainMessage(
                    MyHandler.MESSAGE_QUERY_ROAMING_SETTINGS));*/
            /**
             * response[0] : international_voice_text_roaming (0,1)
             * response[1] : international_data_roaming (0,1)
             * response[2] : domestic_voice_text_roaming (0,1)
             * response[3] : domestic_data_roaming (0,1)
             * response[4] : domestic_LTE_data_roaming (1) no need to care*/
            try {
                // international_voice_text_roaming (0,1)
        ...
        /**
         * Handler class to handle Roaming settings.
         */
        private class MyHandler extends Handler {

            private static final int MESSAGE_QUERY_ROAMING_SETTINGS = 0;
            private static final int MESSAGE_SET_ROAMING_SETTINGS = 1;

            @Override
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case MESSAGE_QUERY_ROAMING_SETTINGS:
                        handleQueryRoamingSettings(msg);
                        break;

                    case MESSAGE_SET_ROAMING_SETTINGS:
                        handleSetRoamingSettings();
                        break;
                    default:
                        break;
                }
        ...
        private void handleQueryRoamingSettings(Message msg) {
            Log.d(TAG, "handleQueryRoamingSettings ");
            AsyncResult ar = (AsyncResult) msg.obj;
            if (ar.exception != null) {
                Log.d(TAG, "handleGetFemtocellList with exception = " + ar.exception);
                ...
                Log.d(TAG, "handleQueryRoamingSettings no exception");
                mRoamingSettings = (Integer[]) ar.result;
            }
        }

        private void handleSetRoamingSettings() {
            Log.d(TAG, "handleSetRoamingSettings ");
        }
    }
    @Override
