        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_CALL_WAITING_MISSED:
                    hangupCallWaiting(MtkDisconnectCause.INCOMING_MISSED);
                    break;
            ...
            if (connection != null) {
                switch (connection.getState()) {
                    case INCOMING:
                        ...
                        break;
                    case WAITING:
                        hangupCallWaiting(MtkDisconnectCause.INCOMING_REJECTED);
                        break;
                    default:
