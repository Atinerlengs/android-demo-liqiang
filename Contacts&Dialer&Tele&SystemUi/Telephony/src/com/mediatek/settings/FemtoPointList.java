...
public class FemtoPointList extends PreferenceActivity
     ...
     * @param preferenceScreen prference screen on which event occurred
     * @param preference preference which is updated
    ...
    public boolean onPreferenceTreeClick(
        ...
        if (TelephonyManager.getDefault().getSimCount() > 1) {
            ...
            gsmCdmaphone.selectFemtoCell(mFemtoPointMap.get(preference),
    ...
    protected void onPause() {
        ...
        if (TelephonyManager.getDefault().getSimCount() > 1) {
            ...
            if (mIsDoingAction) {
                ...
                MtkGsmCdmaPhone gsmCdmaphone =
                    (MtkGsmCdmaPhone) PhoneFactory.getPhone(mPhone.getPhoneId());
                gsmCdmaphone.abortFemtoCellList(
    ...
    /**
     * Handler class to Femto cell selection event.
     */
