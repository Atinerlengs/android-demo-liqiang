...
//*/
/**
 * Class to Update Network type Preference for plmn.
 */
public class NetworkEditor extends PreferenceActivity
    ...
    protected void onCreate(Bundle icicle) {
        //*/ freeme.liqiang, 20180404. adjustt menu item
     ...
     * @param rilNW Network provided by RIL
     * @param subId Sim sub id
     * @return NW id based on App copatible value.
     */
    ...
    /**
     * covertAp NW provided to Ril format.
     * @param modeIndex Network index.
     * @return NW id based on RIL copatible value.
     */
    ...
    private void setScreenEnabled() {
        ...
        invalidateOptionsMenu();
        //M: 03566442 Remove mActSupport to plmn enable.
        mNetworkMode.setEnabled(enable);
    }
    ...
    /**
     * Validate Network id text and show dialog based on it.
     */
