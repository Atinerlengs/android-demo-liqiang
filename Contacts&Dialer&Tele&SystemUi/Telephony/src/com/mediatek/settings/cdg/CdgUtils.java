...
public class CdgUtils {
    ...
    public static boolean isCdgOmhSimCard(int subId) {
        boolean isOmhEnable = MtkTelephonyManagerEx.getDefault().isOmhEnable(subId);
        boolean isOmhCard = MtkTelephonyManagerEx.getDefault().isOmhCard(subId);
    ...
    public static boolean isSupportCallForwarding(int subId) {
        ...
        int[] cffc = MtkTelephonyManagerEx.getDefault().getCallForwardingFc(
                CF_ALL, subId);
    ...
    public static int[] getCallWaitingFc(int subId) {
        return MtkTelephonyManagerEx.getDefault().getCallWaitingFc(subId);
    }
    ...
    public static int[] getDoNotDisturbFc(int subId) {
        return MtkTelephonyManagerEx.getDefault().getDonotDisturbFc(subId);
    }
    ...
    public static int[] getVoiceMessageRetrieveFc(int subId) {
        return MtkTelephonyManagerEx.getDefault().getVoiceMailRetrieveFc(subId);
    }
