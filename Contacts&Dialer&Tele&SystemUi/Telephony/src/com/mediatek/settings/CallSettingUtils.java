...
public class CallSettingUtils {
    ...
    public static boolean isCtVolte() {
        ...
        String feature = SystemProperties.get("persist.mtk_ct_volte_support");
        if (feature.equals("1") || feature.equals("2")) {
            result = true;
        }
        Log.d(TAG, "isCtVolte: " + result + " feature: " + feature);
        return result;
    }
    ...
    public static boolean isCtVolteMix() {
        ...
        Log.d(TAG, "isCtVolteMixEnabled " + result);
        return result;
    }
    ...
    public static boolean isCtVolte4gSim(int subId) {
        return isCtVolte() && TelephonyUtilsEx.isCt4gSim(subId);
    }
    ...
    public static boolean isCtVolteMix4gSim(int subId) {
        return isCtVolteMix() && TelephonyUtilsEx.isCt4gSim(subId);
    }
