...
/**
 * Class to provide Network type Preference dialog to edit.
 */
public class NetworkTypePreference extends DialogPreference
    ...
    /**
     * Add constructor for Network type Preference.
     * @param context Context for Network Editor.
     * @param attrs UI attribute
     */
    ...
    /**
     * Update result for dialog on Click.
     * @param dialog Dialog to display
     * @param which dialog state
     * @param isChecked Dialog checked or not.
     */
    ...
    /**
     * Check network State on init.
     * @param act Network acknowledge.
     */
