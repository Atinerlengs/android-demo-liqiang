...
public class DefaultRttUtilExt implements IRttUtilExt {
    ...
    @Override
    public int combineRttPhoneAccountCapabilities(int capability) {
        return capability;
    }
    ...
    @Override
    public void setupRttTextStream(android.telecom.Connection connection,
        ConnectionRequest request) {
        Rlog.d(TAG , "setupRttTextStream default");
    }
    @Override
    ...
    @Override
    public void setupOutgoingConnectionForRtt(
        android.telecom.Connection connection, ConnectionRequest request) {
        Rlog.d(TAG , "setupOutgoingConnectionForRtt default");
    }
